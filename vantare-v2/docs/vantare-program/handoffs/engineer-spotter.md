...
2026-08-21, último P1 quirúrgico de ISA-718 / PR #739 corregido en `e03129bd`:
...
`32516535276` pasa `Validate promotion path` y `Validate Vantare blocking
gates` sobre `3a43466a`. Pendientes: re-review y gate LMU humano; sin merge ni
promoción.
