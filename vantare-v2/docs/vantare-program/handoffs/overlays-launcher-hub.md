...
### ISA-1221 — revisión de Standings tras aprobar Delta (2026-09-22)

- [VAN-41](https://app.notion.com/p/3dbe51695c658125b1c2efc198edfc94). Isaac confirma Delta terminado sobre `e492aa88`; checklist de Widgets · Revisión actualizado. La rama `vantareapp/isa-1221-standings-review` continúa aislada sobre ese candidato. La integración anterior #1302 → #1298 permanece a cargo del subagente; este cambio no declara integración ni promoción de Delta/Standings.
- Causas: cualquier escena imponía multiclase, el catálogo exponía efectos Endurance inexistentes en Eficiencia y las tres sesiones reutilizaban los datos de carrera del golden. Los coches en boxes del ejemplo quedaban fuera de la ventana visible.
- Workshop Eficiencia expone cambio de posición por piloto (carrera) y entrada/salida de boxes (todas las sesiones). Conserva Normal/Multiclass y los efectos productivos existentes: desplazamiento de filas y destello verde/rojo. Las escenas se reproducen mediante Reproducir; el estado PIT no promete una animación adicional. Endurance conserva su catálogo.
- Fixture Eficiencia con mejor/última vuelta, vueltas completadas y reloj distintos por sesión; práctica/clasificación ordenadas por mejor vuelta. Posiciones de clase y gaps se mantienen coherentes en la escena de cambio de posición. El podio incluye un rival en boxes y Ubicación se aplica al jugador seleccionado. Golden canónico y productores de telemetría no se modifican.
- 183 pruebas de autoría/Standings PASS (incluidas 15 regresiones), build/TypeScript y lint PASS; ratchet PASS, NEW=0 y sin cambios de política. Los interruptores de módulos también reflejan la columna de vuelta por defecto de cada sesión. Workshop sirve el candidato por HMR en 127.0.0.1:5177, HTTP 200. Pendiente verificación visual de Isaac; no se atribuye inspección de navegador ni certificación LMU.
