 ...
 * secciones reales del Studio.
 *
 * - `v3`: controles nativos historicos del Studio V3. Es el valor por defecto,
 *   asi que con el flag Orbit apagado nada cambia.
 * - `orbit`: componentes del kit `ui/orbit`. Solo lo activa
 *   `StudioOrbitInspector`.
 *
 * Vive en `overlay/core` y no en `hub/overlay-studio` porque los inspectores de
 * contenido propios de cada tipo de widget —`StandingsContentInspector`,
 * `RelativeContentInspector`— tambien tienen que elegir piel, y son de
 * `overlay/`: hacerles importar del Hub invertiria las capas.
 *
