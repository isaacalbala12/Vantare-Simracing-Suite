...
| T13–T18 | T13a–e cerrado localmente; T14a #1254 conserva la entrada exacta del cálculo, T14b #1255 la abre por referencia en Go sin fuente, T14c #1257 exige esa misma referencia en el cliente TypeScript, T14d #1259 publica todas las referencias históricas sin payloads, T14e #1260 permite consultar cada resultado exacto, T14f #1261 recupera el comando completo de corrección y T14g #1263 hace lo mismo con `save_revision`. T15a1 #1264 conecta el criterio de orden recorded, T15a2a #1265 prepara conjuntamente las revisiones exactas, T15a2b #1268 conserva el delta de ritmo por piloto, T15a2c #1269 resuelve el orden libre temporal con el reloj exacto de SolverV2 y T15b #1270 conecta preparar/calcular/cancelar con condición seca/mojada explícita y respuestas vigentes. | Completar resultado parcial/final y aceptar/guardar en T15c, stint/parada y paridad. |
...
**Siguiente corte elegible:** T15c presenta el resultado parcial, la optimalidad final y aceptar/guardar separados. T15a1–T15b ya conservan criterio, revisiones, delta de piloto y orden libre temporal sin estimar vueltas por promedio, y conectan preparar/calcular/cancelar sin perfiles sintéticos. A12/A13 siguen abiertos hasta T15c. La disponibilidad horaria legacy necesita otra referencia temporal y permanece pendiente. La aceptación visual permanece en T18 y el recorrido Wails en T22.
