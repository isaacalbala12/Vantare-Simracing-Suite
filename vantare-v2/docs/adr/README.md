...
| 0004 | [Arquitectura modular de Telemetry Core](0004-telemetry-core-modular-observation-architecture.md) | Aceptada |
| 0005 | [Capabilities y límites de Engineer](0005-engineer-projection-capability-contract.md) | Aceptada |
...
| 0009 | [SQLite y MCAP para histórico](0009-historical-storage-sqlite-mcap.md) | SQLite aceptado; MCAP condicionado |
| 0010 | [Helper DuckDB fuera de proceso](0010-duckdb-helper-for-historical-telemetry.md) | Aceptada |
