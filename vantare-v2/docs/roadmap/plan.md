...
- cuerpo: Eficiencia ofrece los estilos Signature y Broadcast para Standings, con transparencia suave, identidad Vantare, tipografía unificada y selección neutra. Cabecera y pie fino permiten elegir información de sesión; las diagonales reflejan la bandera sin animación cuando existe una señal vigente. La fuente REST LMU aporta temperaturas con calidad y caducidad y una bandera fail-closed; su equivalencia de códigos exige comprobación en sesión activa. Los perfiles conservan la selección y el marco adapta columnas, filas y pie en Studio, Desktop y OBS. La entrega conjunta quedó validada físicamente e integrada en Nightly mediante PR #1107; la equivalencia de bandera y temperatura sigue pendiente de una sesión LMU activa. La recuperación de los ajustes locales de Delta, Relative, Standings, Pedals y Fuel Strategy ha pasado las pruebas funcionales y los controles de calidad; Isaac ha autorizado su integración inicial en Nightly y la revisión visual continúa en Workshop, sin certificar todavía LMU activo. El candidato posterior conserva Delta sin pulso numérico, aprobado visualmente, y corrige escenas, mocks por sesión y PIT en Workshop. Standings Eficiencia incorpora la animación intermedia aprobada para conducción: desplazamiento continuo con puestos ganados o perdidos, aviso contenido de mejora personal y récord de sesión, y PIT que acompaña a su fila, un acento discreto para batallas entre rivales de la misma clase y transiciones suaves al entrar o salir pilotos de la ventana visible. Workshop reúne todas estas animaciones en la secuencia combinada y permite revisar la ventana también en V1, con pasos sincronizados, pilotos de referencia visibles y encuadre estable. Respeta la reducción de movimiento y la continuidad de la fuente; esta ampliación sigue pendiente de revisión visual e integración.
- cuerpo.en: Efficiency offers Signature and Broadcast Standings styles, with subtle transparency, Vantare identity, unified typography and neutral selection. The header and thin footer offer selectable session information; diagonal accents reflect the flag without animation when a current signal exists. The LMU REST source supplies temperatures with quality and expiry plus a fail-closed flag; its code mapping requires an active-session check. Profiles retain selections and the frame fits columns, rows and footer across Studio, Desktop and OBS. The joint delivery was physically validated and integrated into Nightly through PR #1107; flag and temperature equivalence still awaits an active LMU session. Recovery of local Delta, Relative, Standings, Pedals and Fuel Strategy refinements has passed functional tests and quality checks; Isaac has authorized initial Nightly integration and visual review continues in Workshop, without active LMU certification yet. The later candidate retains the visually approved Delta without a numeric pulse and fixes Workshop scenes, session mocks and PIT. Efficiency Standings adds the approved intermediate driving motion: continuous row movement with position changes, restrained personal and session lap notices, and PIT moving with its row, a subtle accent for battles between same-class rivals, and smooth transitions as drivers enter or leave the visible window. Workshop includes all these animations in its combined sequence and supports window review in V1 as well, with synchronized steps, visible reference drivers and a stable preview frame. It respects reduced motion and source continuity; this extension still awaits visual review and integration.
- cuerpo.pt: Eficiência oferece os estilos Signature e Broadcast para Standings, com transparência suave, identidade Vantare, tipografia unificada e seleção neutra. Cabeçalho e rodapé fino permitem escolher informação da sessão; as diagonais refletem a bandeira sem animação quando existe um sinal atual. A fonte REST LMU fornece temperaturas com qualidade e expiração e uma bandeira fail-closed; o mapeamento dos códigos exige verificação numa sessão ativa. Os perfis preservam a seleção e o quadro adapta colunas, filas e rodapé no Studio, Desktop e OBS. A entrega conjunta foi validada fisicamente e integrada na Nightly através do PR #1107; a equivalência da bandeira e da temperatura continua pendente de uma sessão LMU ativa. A recuperação dos ajustes locais de Delta, Relative, Standings, Pedals e Fuel Strategy passou nos testes funcionais e controlos de qualidade; Isaac autorizou a integração inicial na Nightly e a revisão visual continua no Workshop, ainda sem certificar LMU ativo. O candidato posterior conserva Delta sem pulso numérico, aprovado visualmente, e corrige cenas, dados por sessão e PIT no Workshop. Standings Eficiência incorpora o movimento intermédio aprovado para condução: filas contínuas com posições ganhas ou perdidas, avisos discretos de melhoria pessoal e recorde da sessão, e PIT ligado à fila, um destaque discreto para disputas entre rivais da mesma classe e transições suaves ao entrar ou sair pilotos da janela visível. O Workshop reúne todas estas animações na sequência combinada e permite rever a janela também em V1, com passos sincronizados, pilotos de referência visíveis e enquadramento estável. Respeita movimento reduzido e continuidade da fonte; esta extensão aguarda revisão visual e integração.
- cuerpo.it: Efficienza offre gli stili Signature e Broadcast per Standings, con trasparenza lieve, identità Vantare, tipografia unificata e selezione neutra. Intestazione e piè sottile permettono di scegliere informazioni di sessione; le diagonali riflettono la bandiera senza animazione quando esiste un segnale attuale. La fonte REST LMU fornisce temperature con qualità e scadenza e una bandiera fail-closed; la mappatura dei codici richiede una verifica in sessione attiva. I profili conservano la selezione e il riquadro adatta colonne, righe e piè in Studio, Desktop e OBS. La consegna congiunta è stata verificata fisicamente e integrata in Nightly tramite la PR #1107; l'equivalenza di bandiera e temperatura resta in attesa di una sessione LMU attiva. Il recupero degli aggiornamenti locali di Delta, Relative, Standings, Pedals e Fuel Strategy ha superato i test funzionali e i controlli di qualità; Isaac ha autorizzato l’integrazione iniziale in Nightly e la revisione visiva continua in Workshop, senza certificare ancora LMU attivo. Il candidato successivo conserva Delta senza impulso numerico, approvato visivamente, e corregge scene, dati per sessione e PIT nel Workshop. Standings Efficienza aggiunge il movimento intermedio approvato per la guida: righe continue con posizioni guadagnate o perse, avvisi discreti di miglioramento personale e record di sessione, e PIT legato alla riga, un accento discreto per le battaglie tra rivali della stessa classe e transizioni fluide quando i piloti entrano o escono dalla finestra visibile. Workshop include tutte queste animazioni nella sequenza combinata e permette di verificare la finestra anche in V1, con passi sincronizzati, piloti di riferimento visibili e inquadratura stabile. Rispetta movimento ridotto e continuità della fonte; questa estensione attende revisione visiva e integrazione.
- etiqueta: ISA-1083
