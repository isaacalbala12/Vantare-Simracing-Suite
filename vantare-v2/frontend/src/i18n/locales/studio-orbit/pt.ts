...
export const studioOrbitPt: Record<string, string> = {
  ...
  "studio.toolbar.wallpaper.adding": "A importar…",
  "studio.toolbar.wallpaper.empty": "Ainda não há fundos próprios. Adiciona uma captura do simulador.",
  "studio.toolbar.wallpaper.remove": "Remover {{name}}",
  "studio.toolbar.wallpaper.hint": "Ficam guardados neste computador, até {{n}}.",
  "studio.toolbar.wallpaper.errorType": "Esse ficheiro não é uma imagem.",
  ...
  "studio.inspector.section.content": "Conteúdo",
  "studio.inspector.section.layout": "Layout",
  "studio.inspector.section.actions": "Ações",
  ...
  "studio.inspector.content.playerWindow": "Pódio e janela do jogador",
  "studio.inspector.content.windowAround": "Pilotos ao redor",
  ...
  "studio.inspector.content.nameFormat.initial": "N. Apelido",
  "studio.inspector.content.nameFormat.surname": "Apelido",
  ...
  "overlay.inspector.relative.showBrand": "Mostrar marca Vantare",
  ...
  "overlay.inspector.efficiency.info.none": "Nenhum",
  "overlay.inspector.efficiency.info.trackTemperature": "Temperatura da pista",
  "overlay.inspector.efficiency.info.airTemperature": "Temperatura do ar",
  "overlay.inspector.efficiency.info.estimatedLaps": "Voltas restantes estimadas",
  "overlay.inspector.efficiency.info.totalLaps": "Voltas totais",
  "overlay.inspector.efficiency.info.track": "Circuito",
  "overlay.inspector.efficiency.info.remaining": "Tempo restante",
  "overlay.inspector.efficiency.info.rain": "Chuva",
  "overlay.inspector.efficiency.info.wetness": "Pista molhada",
  ...
  "overlay.inspector.pedals.showBrand": "Mostrar marca Vantare",
  ...
  "studio.topbar.autoSaved": "Guardado automaticamente",
  "studio.topbar.savePending": "Gravação pendente…",
  "studio.topbar.retrySave": "Tentar guardar novamente",
  "studio.topbar.openOverlay": "Abrir overlay",
  "studio.topbar.stopOverlay": "Parar overlay",
  "studio.topbar.performanceMode": "Política do perfil",
