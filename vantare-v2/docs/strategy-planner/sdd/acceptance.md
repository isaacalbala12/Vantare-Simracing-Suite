...
| A14 | R15 | Stint/parada editables con recursos, ventanas, inventario y coste válidos; drag y teclado equivalentes. No doble conteo de servicio ni reserva negativa. | Stint PASS local en #1273/#1274: comparación, drag/teclado, obsolescencia y coste. Parada T17, capturas T18 y gate integral T22 pendientes. |
