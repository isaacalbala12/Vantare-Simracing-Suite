...
|---|---|---|
| Diseño y entrada | Asistente A4 unificado, biblioteca productiva #1093–1095, configuración guardada/reabierta y panel funcional de cálculo/plan/stint/parada hasta #1276. El preflight nativo de T18 #1277 convirtió fuentes en una pantalla completa y añadió la segunda observación automática que libera DuckDB estables; `pass-28-computer-use` conserva 22 estados principales y 72 variantes responsive ES/EN/PT/IT, corrige la lista integrada de sesiones y acredita la salida/reintento tras una parada inviable. La base visual mantiene 9,2/10. | Confirmar apertura real y completar el recorrido Wails T22. |
| Lectura/correcciones | Valor, uso por familia, clasificación y catálogo canónico v4 #1096/#1099/#1104. Banco J9 bidireccional Imola↔Monza conserva hashes originales. T13a–e #1211/#1212/#1214/#1216/#1220 cierra localmente contrato, validación, custodia v5, derivados, servicio, cliente, edición avanzada e historial de límites. T14f #1261 conserva el comando completo antes de guardar, lo recupera con una nueva sesión autorizada y exige reconocimiento explícito. | Gate nativo/visual T18/T22. |
| Selección exacta | Documento/cliente/adapter #1084–1088 y adopción explícita desde Datos/Revisiones. T14a #1254 guarda en la revisión Orbit la petición exacta asociada al resultado y detecta cambios de fuente. T14b #1255 permite al bridge Go abrir esa revisión exacta sin proveedor de fuentes. T14c #1257 alinea el cliente TypeScript y rechaza una revisión válida ausente o distinta. T14d #1259 publica todas las referencias históricas mediante `list`, sin payloads. T14e #1260 permite consultar cada resultado exacto desde Mis estrategias. T14g #1263 custodia `save_revision`, recupera la intención exacta tras reiniciar y exige decisión explícita. | Gate nativo T22. |
| Motor/entradas | SolverV2, replay final y corrección local del coste repetido #1089; transporte de reglas #1092; horizonte exacto por vueltas T02d1 #1222; capacidad/reservas T02d2a #1224; cargas fijas del solver T02d2b #1225 y transporte Go T02d2c #1226; #1246 distingue orden fijo y selección libre por vueltas; T03a #1248 distingue cancelación de timeout, T03b #1249 evita reutilizar comandos entre montajes, T03c #1250 espera la telemetría seleccionada, T03d #1251 rechaza optimalidad desconocida y T03e #1252 distingue presupuesto agotado de inviabilidad con clima. T15a1 #1264 conserva en el borrador recorded el criterio fijo/libre, permite ordenar la rotación y lo adapta al contrato exacto de cálculo. T15a2a #1265 prepara conjuntamente sus revisiones exactas con la autoridad Analysis existente, sin crear otro evento. T15a2b #1268 suma después el delta explícito de cada piloto y conserva consumo y perfiles. T15a2c #1269 lleva la duración al mismo SolverV2 y habilita la selección libre temporal con reloj exacto. T15b #1270 conecta preparar/calcular/cancelar y T15c #1271 presenta cobertura parcial o plan exacto, optimalidad verificable y aceptación recuperable separada del guardado de configuración. T16a #1273 reutiliza `order` y los overrides de vueltas para comparar en una misma orden la propuesta exacta con una variante de stint restringida; T16b #1274 conecta piloto, límites por arrastre/teclado, obsolescencia, recálculo y coste frente a la base. T17a #1275 fija cantidades de Fuel/VE y decisiones físicas de neumáticos por parada en el replay único, con el modo de servicio gobernado por el evento. T17b #1276 conecta esos servicios a Plan con desglose, obsolescencia, recálculo sin nueva preparación y coste exacto frente al plan vigente. | T02/T06/T07 conservan disponibilidad horaria; T18/T22 mantienen aceptación visual y nativa. |
...
| Calidad | Gates locales y bancos por corte; T12 local cerrado en c2d5b45b. T18 aporta matriz visual reproducible, responsive sin overflow/error y revisión separada >9/10 por pantalla. | WebView2 ERROR_INVALID_STATE sin causa demostrada, aceptación nativa/distribución y precisión empírica. |
...
modelo/reglas y horizonte declarados. El resultado publica versión del modelo y
objetivo. `proven` exige que el replay final coincida con la decisión optimizada,
sin edición de variante ni degradación por presupuesto; cualquier otro plan
factible es `not_proven`. Distinguir ambos de parcial, inviable, cancelado y
...
solver, replay, peor caso y clima sin alterar el camino legado. T02d2c las
conecta al evento Go y a la evaluación final, incluido el remanente VE entre
stints. Queda el puente TypeScript y la conexión del asistente.
