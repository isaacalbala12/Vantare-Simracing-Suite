...
| 12 · T18 / #1277 · corregido tras preflight nativo | Capturas comparables de asistente, biblioteca en pantalla A4 completa, Carrera, Datos avanzado, Cálculo, Plan, Revisiones, Stint y Parada. La UI repite la observación segura para liberar DuckDB estables. | `pass-27-runtime-source-screen`: 19 principales y 72 variantes ES/EN/PT/IT, incluida la entrada real desde Combinación; conjunto 9,2/10 en revisión GPT-5.6 Sol medium, sin overflow ni P0/P1/P2. T22 debe confirmar apertura real, persistencia, reinicio, copia, errores y licencia. |
