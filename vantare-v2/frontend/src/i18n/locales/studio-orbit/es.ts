...
export const studioOrbitEs: Record<string, string> = {
  ...
  "studio.toolbar.wallpaper.adding": "Importando…",
  "studio.toolbar.wallpaper.empty": "Todavía no hay fondos propios. Añade una captura del simulador.",
  "studio.toolbar.wallpaper.remove": "Quitar {{name}}",
  "studio.toolbar.wallpaper.hint": "Se guardan en este equipo, hasta {{n}}.",
  "studio.toolbar.wallpaper.errorType": "Ese fichero no es una imagen.",
  "studio.toolbar.wallpaper.errorSize": "La imagen pesa demasiado.",
  "studio.toolbar.wallpaper.errorDecode": "No se pudo leer la imagen.",
  "studio.toolbar.wallpaper.errorQuota": "No cabe: quita algún fondo y vuelve a probar.",
  "studio.toolbar.wallpaper.suspendBlocker": "Studio está importando un fondo sin aplicar",
  ...
  "studio.inspector.content.redlineFixed": "Posición y Piloto son anclajes fijos de Redline.",
  "studio.inspector.content.redlineWidthWarning": "Ensancha el widget a al menos {width} px para evitar recortes.",
  ...
  "overlay.inspector.efficiency.info.none": "Ninguno",
  "overlay.inspector.efficiency.info.trackTemperature": "Temperatura de pista",
  "overlay.inspector.efficiency.info.airTemperature": "Temperatura del aire",
  "overlay.inspector.efficiency.info.estimatedLaps": "Vueltas restantes estimadas",
  "overlay.inspector.efficiency.info.totalLaps": "Vueltas totales",
  "overlay.inspector.efficiency.info.track": "Circuito",
  "overlay.inspector.efficiency.info.remaining": "Tiempo restante",
  "overlay.inspector.efficiency.info.rain": "Lluvia",
  "overlay.inspector.efficiency.info.wetness": "Pista mojada",
  ...
  "studio.system.vantare-functional": "Eficiencia",
