...
- cuerpo.it: Studio riconosce documenti salvati equivalenti; le tabelle Crystal rispettano le colonne e adattano l'altezza al numero di righe. I pedali conservano la cronologia e mostrano R/N, colori configurati e una scala RPM senza simulare il limitatore dell'auto. Track Map ha sfondo trasparente e legenda delle classi. I confronti spiegano riferimenti e dati assenti; Head-to-Head protegge la geometria. Dense contiene i tre pedali e la cronologia a 560×100; Broadcast omette limiti di giri non validi o illimitati. Il ciclo di vita della finestra overlay desktop serializza apertura e arresto: un avvio concorrente non lascia finestre orfane e arrestare durante la creazione non fa riapparire l'overlay. La restante verifica fisica è in attesa.
...
- cuerpo: Eficiencia ofrece los estilos Signature y Broadcast para Standings, con transparencia suave, identidad Vantare, tipografía unificada y selección neutra. Cabecera y pie fino permiten elegir información de sesión; las diagonales reflejan la bandera sin animación cuando existe una señal vigente. Bandera y temperaturas quedan sin dato mientras la fuente real no las proporcione. Los perfiles conservan la selección y el marco adapta columnas, filas y pie en Studio, Desktop y OBS. Entrega opt-in en ramas de issue, pendiente de comprobación conjunta e integración a Nightly. Acceso y marca por licencia continúan por separado en ISA-1097.
- cuerpo.en: Efficiency offers Signature and Broadcast Standings styles, with subtle transparency, Vantare identity, unified typography and neutral selection. The header and thin footer offer selectable session information; diagonal accents reflect the flag without animation when a current signal exists. Flags and temperatures remain unavailable until supplied by the real source. Profiles retain selections and the frame fits columns, rows and footer across Studio, Desktop and OBS. Opt-in delivery on issue branches, pending joint validation and Nightly integration. License access and branding continue separately in ISA-1097.
- cuerpo.pt: Eficiência oferece os estilos Signature e Broadcast para Standings, com transparência suave, identidade Vantare, tipografia unificada e seleção neutra. Cabeçalho e rodapé fino permitem escolher informação da sessão; as diagonais refletem a bandeira sem animação quando existe um sinal atual. Bandeiras e temperaturas ficam sem dados até a fonte real os fornecer. Perfis preservam a seleção e o quadro adapta colunas, filas e rodapé no Studio, Desktop e OBS. Entrega opcional em branches de issue, pendente de verificação conjunta e integração Nightly. Acesso e marca por licença continuam separadamente em ISA-1097.
- cuerpo.it: Efficienza offre gli stili Signature e Broadcast per Standings, con trasparenza lieve, identità Vantare, tipografia unificata e selezione neutra. Intestazione e piè sottile permettono di scegliere informazioni di sessione; le diagonali riflettono la bandiera senza animazione quando esiste un segnale attuale. Bandiere e temperature restano senza dati finché la fonte reale non li fornisce. Profili conservano la selezione e il riquadro adatta colonne, righe e piè in Studio, Desktop e OBS. Consegna opzionale su branch di issue, in attesa di verifica congiunta e integrazione Nightly. Accesso e marchio per licenza proseguono separatamente in ISA-1097.
- etiqueta: ISA-1083
