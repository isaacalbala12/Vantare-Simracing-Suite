...
> HISTÓRICO, sustituido por decisión de Isaac el 2026-09-03. Ninguna fase A–J
> de este documento autoriza trabajo nuevo. La única secuencia activa es el
> [plan maestro de Telemetría V2](2026-09-03-telemetria-v2-plan-maestro.md).
> Se conserva el contenido para trazabilidad de decisiones y compromisos;
> los pendientes excluidos del nuevo programa no se consideran entregados.
