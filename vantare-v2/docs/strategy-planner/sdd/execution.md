...
| T02/T03/T06/T07 | Reglas transportadas en #1092; T02d1 #1222 añade horizonte por vueltas; T02d2a #1224 transporta capacidad/reservas; T02d2b #1225 fija cargas en SolverV2, T02d2c #1226 las conecta a CalculateOrbit Go y T02d2d #1227 adapta el evento TypeScript desde el asistente. T02e backend #1228 acredita curvas/vida derivadas y conecta inventario físico explícito; T02e3 #1229 alinea su contrato TypeScript y T02e4 #1230 lo custodia en el borrador recorded y lo transporta sin convertir agregados. T02f1 #1231 transporta el desglose explícito de parada al modelo único del solver, T02f2 #1232 separa el tiempo de formación en reloj, conducción y horizonte, T02f3a #1233 alinea el cliente TypeScript y T02f3b #1234 custodia ambos datos en el borrador recorded y los adapta al evento. T02g1 #1235 aplica el perfil del único piloto antes de optimizar cuando existen límites; T02g2a #1236 permite que SolverV2 conserve una secuencia cíclica opcional sin perder su selección libre; #1238 mantiene el presupuesto para secuencias largas con pilotos equivalentes; T02g2b #1237 conecta perfiles y secuencia desde Strategy; T02g3 #1246 distingue rotación fija y selección libre por vueltas en CalculateOrbit; T07a #1240 edita máximos continuo y total, T07b #1241 añade mínimo/máximo de vueltas, T06a #1242 edita ventanas obligatorias de pit, T06b #1243 compuestos obligatorios, T06c #1244 compuestos permitidos por clima y T07c #1245 indisponibilidad por vueltas en los contratos existentes; duración, Fuel/VE, paradas, nombres y delta ya están presentes. | Resolver disponibilidad horaria sin convertirla por ritmo medio, conectar el selector de orden recorded y el modo libre temporal en T15, clima individual #1239 y estados finales. Una pantalla presente no cierra la familia. |
...
**Siguiente corte elegible:** T03 completa el contrato único de resultados y
estados. El backend ya distingue orden fijo y selección libre por vueltas; el selector
