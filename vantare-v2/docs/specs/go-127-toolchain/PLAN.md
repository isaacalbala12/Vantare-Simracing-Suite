...
2. Cambiar Go en módulo y workflows activos; mantener Wails beta.24. Alinear el manifiesto de calidad y hacer que Doctor use ese dato, con prueba focal. Reconstruir herramientas locales con Go 1.27.1. No modificar Engineer, helper publicado ni Dockerfiles alternativos.
