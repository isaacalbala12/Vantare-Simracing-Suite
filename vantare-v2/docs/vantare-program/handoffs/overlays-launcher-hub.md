...
El seguimiento está en [PR draft #1354](https://github.com/isaacalbala12/Vantare-Simracing-Suite/pull/1354), rama `vantareapp/isa-1347-nightly-parser-perf` desde el SHA integrado, head inicial `17c0e91a`. La comprobación de tamaño evita asignaciones UTF-8 para JSON ASCII y conserva la medición exacta para Unicode y el límite de 72 KiB. Evidencia local: frontend completo 481 archivos, 4.036 PASS y 2 omitidas antes del ajuste equivalente del patrón ASCII para ESLint; suite focal final 24/24, legacy 0,686 ms y compacto 0,812 ms; typecheck, lint y build PASS. CI remoto del seguimiento está pendiente.
