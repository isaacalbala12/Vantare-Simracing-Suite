...
describe("Functional Standings", () => {
  ...
  it("accepts the implemented Workshop pairs and rejects unsupported widgets", () => {
    ...
    for (const widget of ["relative", "delta", "pedals", "pedals-telemetry", "track-weather", "track-map", "fuel-strategy", "car-damage-numbers", "input-telemetry", "racing-flags", "race-schedule"] as const) {
