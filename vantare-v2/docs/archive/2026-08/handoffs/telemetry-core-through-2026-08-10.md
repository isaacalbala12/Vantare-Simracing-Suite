# Snapshot histórico — Telemetry Core hasta 2026-08-10

> **Archivado y sin autoridad operativa.** Conserva la cronología que acumuló
> el antiguo handoff vivo. Continúa desde
> [`docs/vantare-program/handoffs/telemetry-core.md`](../../../vantare-program/handoffs/telemetry-core.md).
...
- `docs/adr/0009-historical-storage-sqlite-mcap.md` y
