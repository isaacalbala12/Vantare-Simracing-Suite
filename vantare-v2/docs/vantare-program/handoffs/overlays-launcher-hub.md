...
Prueba de regresión: la cabecera carece del indicador y acepta una versión nueva en el mismo montaje. Reproducción roja antes del cambio; después, 36/36 pruebas focales y typecheck pasan. El hito `orbit-v1-12` y su digest derivado reflejan el ajuste sin dar por completado todo el hito. Suite completa, lint y build en ejecución; quedan por consignar los resultados y abrir PR draft. Sin merge ni promoción.
