...
import { resolveMinimumWidthFrameLayout, resolveStandingsRedlineMinimumWidth } from "../widget-types/standings/standings-redline-layout";
...
describe("Redline Tower productive selection", () => {
  ...
  it.each([280, 340, 482, 650])("preserves a physical %ipx frame and all twelve complete rows", (width) => {
    ...
    expect(resolveMinimumWidthFrameLayout(widget.layout, resolveStandingsRedlineMinimumWidth(widget), 1920)).toEqual(widget.layout);
