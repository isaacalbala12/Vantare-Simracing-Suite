...
const OFFICIAL_DESIGN_DEFINITIONS: WidgetDesignV1[] = [
  ...
  { id: "delta-endurance-redline", name: "Endurance Redline", widgetType: "delta", systemId: "vantare-endurance", systemVersion: 1, configVersion: 1, visual: { templateId: "delta-redline", showHeader: true }, includesContent: false, origin: "vantare" },
