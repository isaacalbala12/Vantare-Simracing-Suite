...
| R3b · mismo operador | S3 las tres Relative. Después de R2; no necesita esperar la review de R3a | Capturas/vídeo breve/atestación, sin código | Cada variante contrastada con identidades/orden V2; máximo 5 min por variante, sin cambiar contrato para esconder saltos |
| R3c · mismo operador | S3 Pedals. Después de R2; no necesita esperar la review de R3b | Capturas/atestación, sin código | Reposo y entrada real/saturación disponibles, contención y transparencia; máximo 5 min |
