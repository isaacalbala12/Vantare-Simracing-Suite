...
- Mantén la estricta separación de responsabilidades: `WidgetStudio` edita apariencia y datos (nunca posición/tamaño). `LayoutStudio` edita posición y tamaño en el lienzo (nunca apariencia).
