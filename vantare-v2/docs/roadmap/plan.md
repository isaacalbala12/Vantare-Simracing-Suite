...
- cuerpo: Driver LMU con reconexión acotada, transporte Overlay dirigido con una sola entrega pendiente compartida por Desktop y Studio, lifecycle V2 recuperable sin frames y proyecciones de overlay, ingeniero y estrategia.
- cuerpo.en: LMU driver with bounded reconnects, targeted Overlay transport with one pending delivery shared by Desktop and Studio, a V2 lifecycle recoverable without frames, and overlay, engineer and strategy projections.
- cuerpo.pt: Driver LMU com reconexão limitada, transporte Overlay dirigido com uma única entrega pendente partilhada por Desktop e Studio, lifecycle V2 recuperável sem frames e projeções de overlay, engenheiro e estratégia.
- cuerpo.it: Driver LMU con riconnessione limitata, trasporto Overlay diretto con una sola consegna pendente condivisa da Desktop e Studio, lifecycle V2 recuperabile senza frame e proiezioni di overlay, engineer e strategia.
- etiqueta: En desarrollo
- etiqueta.en: In progress
- etiqueta.pt: Em desenvolvimento
- etiqueta.it: In corso
