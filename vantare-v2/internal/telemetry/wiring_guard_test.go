...
var wiringGuardExistingContractBaseline = map[string]struct{}{
	...
	// ISA-372 F10 (2026-08-20): el driver sintetico SimX solo se registra tras
	// el flag de diagnostico TelemetrySimXDriver, apagado por defecto. Su
	// matriz de autoridad es contrato declarado y superficie de conformidad,
	// igual que la de LMU justo encima.
	"internal/telemetry/drivers/simx.AuthorityMatrix":            {},
