...
Actualización ISA-861 (2026-08-27, candidata de promoción sobre
`origin/nightly@1d3ab03d`):
...
- Estado externo al escribir esta nota: rama local de ISA-861; push, PR, CI y
  merge a `nightly` pendientes. La prueba Wails/LMU real continúa siendo el
  gate posterior; `testers`, `master` y release quedan fuera.
