...
Isaac solicita un radar para pilotos cercanos inspirado por TinyPedal, RaceLab y LMU. El seguimiento vivo está en [Asana · Radar](https://app.asana.com/1/1210926733859493/project/1218742976551956/task/1218838171528031); la [issue #1388](https://github.com/isaacalbala12/Vantare-Simracing-Suite/issues/1388) define el alcance técnico. Rama aislada `vantareapp/isa-1388-radar-proximidad`, reconciliada sobre Nightly `446001dd` tras la fusión de #1386.
...
Comprobación actual: pruebas Go de proyección, transporte y replay PASS; TypeScript, lint y build PASS; 151 pruebas focales frontend y 4 pruebas del presupuesto de frame PASS tras la reconciliación. La primera suite frontend completa expuso seis listas cardinales antiguas ya actualizadas y un timeout de Playwright bajo carga. La segunda pasó 4102 pruebas y 2 omitidas, con un único timeout de Redline que pasó aislado. La suite Go completa encontró una prueba temporal de Engineer Fuel que pasó aislada; el alcance radar está verde. Vista del Workshop 5174 revisada en navegador. Pendientes: CI remoto, revisión visual de Isaac y prueba física LMU/Windows/OBS. Sin integración de este radar ni promoción adicional.
