...
const en = {
  ...
  trackTemperature: "TRACK", airTemperature: "AIR", estimatedLaps: "EST. LAPS LEFT",
  totalLaps: "TOTAL LAPS", rain: "RAIN", wetness: "WET TRACK",
...
export const functionalLabels: Record<Locale, typeof en> = {
  ...
  es: { ...en, driverName: "PILOTO", vehicleClass: "CLASE", gap: "AL LÍDER", paceGap: "AL MEJOR",
    ...
    trackTemperature: "PISTA", airTemperature: "AIRE", estimatedLaps: "V. REST. EST.", totalLaps: "V. TOTALES", rain: "LLUVIA", wetness: "PISTA MOJADA",
    trackTemp: "PISTA", ambientTemp: "AIRE", wind: "VIENTO", track: "CIRCUITO",
  ...
  pt: { ...en, driverName: "PILOTO", vehicleClass: "CLASSE", gap: "AO LÍDER", paceGap: "AO MELHOR",
    ...
    trackTemperature: "PISTA", airTemperature: "AR", estimatedLaps: "V. REST. EST.", totalLaps: "V. TOTAIS", rain: "CHUVA", wetness: "PISTA MOLHADA",
    trackTemp: "PISTA", ambientTemp: "AR", wind: "VENTO", track: "CIRCUITO",
  ...
  it: { ...en, driverName: "PILOTA", vehicleClass: "CLASSE", gap: "DAL LEADER", paceGap: "DAL MIGLIORE",
    ...
    trackTemperature: "PISTA", airTemperature: "ARIA", estimatedLaps: "GIRI REST. ST.", totalLaps: "GIRI TOTALI", rain: "PIOGGIA", wetness: "PISTA BAGNATA",
    trackTemp: "PISTA", ambientTemp: "ARIA", wind: "VENTO", track: "CIRCUITO",
