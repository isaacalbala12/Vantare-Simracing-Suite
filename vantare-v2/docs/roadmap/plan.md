...
- cuerpo: Dirección visual aceptada: asistente de cinco pasos (Inicio, Combinación, Reglas, Pilotos y Sesiones) y editor A4/Orbit con Carrera, Datos, Plan, Revisiones, stint y parada. Combinación reúne simulador, evento personalizado o calendario Vantare, coche/categoría y circuito. En desarrollo local, Analysis valida y guarda conjuntos de correcciones escalares con historial, conflictos, reintentos y recuperación; los aplica sobre una vista separada y recalcula sus derivaciones conservando originales y calidad. Las proyecciones admiten referencias completas de sesión/base/revisión/snapshot; Analysis deriva desde la revisión guardada exacta y el cliente valida estas referencias. El servicio prepara, guarda, consulta y proyecta correcciones desde una sesión abierta revalidada, con custodia persistente y clasificación recalculada. El cliente nativo valida las respuestas y propaga cancelación sin reintentos automáticos. Documento y cliente conservan revisiones exactas y rechazan proyecciones discordantes; cambiar selección descarta derivados anteriores conservando ajustes. El adaptador autorizado proyecta conjuntamente revisiones exactas de sesiones abiertas. Strategy ya solicita esas revisiones al adaptador y valida su respuesta sin sustituciones. El contrato de cálculo admite reglas explícitas de evento y las conserva al optimizar y revalidar la decisión; el documento y cliente conservan reglas con procedencia y versión compatible, y T15b ya las lleva desde el borrador visible al mismo motor. La búsqueda del solver reutiliza costes de servicios idénticos dentro de cada cálculo sin reducir alternativas; el caso de regresión de Imola vuelve a completar el cálculo en pruebas locales. El descubrimiento nativo admite hasta 1024 archivos sin confundir exceso de límite con formato incompatible. El panel productivo de Sesiones permite apertura explícita, preparación y selección de revisiones; el recorrido nativo se contrasta con carreras reales conservando sus originales. La sección Estrategia abre el asistente A4 de cinco pasos con combinación unificada, reglas, pilotos y sesiones. Permite descubrir y aceptar una fuente explícita, guardar configuración en el repositorio nativo y reabrirla desde Mis estrategias. El resumen conserva los datos ausentes y no presenta un cálculo como completado. El panel Plan ya conecta preparación, cálculo y cancelación sobre revisiones exactas, con condición seca/mojada explícita y sin guardado automático. La paridad visual T18 está cerrada localmente y pass-28 acredita las regresiones de sesiones y recuperación del editor; la validación Wails T22 sigue pendiente. LMU/DuckDB es el primer adapter; otros simuladores usarán sus formatos. Las fuentes originales permanecen intactas, con copia opcional. Se mantienen resultados parciales, Fuel y energía virtual separados, estimaciones de pilotos y revisiones reproducibles. El inventario inicial cubre 367 archivos; siguen pendientes anotación independiente, calibración de criterios y carreras completas reservadas. El solver ya distingue factibilidad y optimalidad y comprueba recursos, reservas y horizonte temporal; su precisión física y aceptación Wails requieren evidencia real. Live e investigación OSS/Monte Carlo quedan para después de completar el flujo registrado. La entrega se organiza en un SDD integral con tareas dependientes, criterios de aceptación y continuidad entre cortes; sólo las decisiones reales de producto y promociones requieren nueva intervención. La biblioteca permite buscar nombres locales saneados, filtrar disponibilidad, ordenar por fecha y recorrer páginas de 25 archivos sin abrir contenido automáticamente. Datos ya permite consultar muestras originales por páginas y preparar correcciones con motivo, guardarlas por separado, comprobar una confirmación incierta y adoptar la revisión explícitamente. Las operaciones de edición previstas ya están conectadas y la aceptación visual T18 está cerrada localmente; sigue pendiente la aceptación nativa T22. Revisiones permite consultar la revisión exacta de una fuente, recorrer sus padres, restaurar como nueva revisión con motivo y elegir explícitamente sus datos para la carrera. Datos distingue señales consultables de señales con correcciones verificables. El historial completo del plan ya es consultable; Analysis y Strategy recuperan tras reiniciar sus comandos completos de corrección y `save_revision`. Orbit no ejecuta el guardado recuperado automáticamente: permite comprobar la revisión exacta, reintentar la misma identidad o cerrar el aviso. La vista principal de Datos consulta vueltas de una revisión exacta, agrupadas por límites de stint registrados. Permite proponer uso por ritmo, Fuel, VE, neumáticos o ahorro con motivo, sin eliminar datos sanos de otras familias; las muestras quedan en vista avanzada. Guardado, descarte y restauración conservan el conjunto mixto completo. Clasificación muestra original, guardado y propuesta y permite corregir tipo, clima e identidad canónica de simulador/coche/clase/circuito mediante el catálogo autorizado, con historial v4 reversible. Un banco real bidireccional Imola↔Monza confirma la proyección y restauración sin alterar los DuckDB originales. #1208 ya alinea `GPS Time`, cobertura, Fuel, energía virtual, desgaste y boxes en un único reloj acreditado. El banco real S125/S266/S026 elimina los límites `fuel_jump` fantasma, conserva los límites correctos y mantiene hashes/WAL intactos; las visitas abiertas no fabrican final ni recursos. El contrato, la validación, la custodia v5, la vista efectiva, el servicio y el cliente ya permiten mover, retirar, restaurar y revisar límites registrados sin alterar la fuente; queda la validación visual y nativa final. El plan de cierre distingue lo implementado de lo validado: primero anclas temporales y límites, completar reglas, perfiles y entradas pendientes, revisiones reproducibles y cálculo conectado; después edición de stint/parada y aceptación visual, empírica y nativa. La calibración y el diagnóstico nativo se preparan antes del cierre para resolver sus bloqueos sin detener trabajo independiente. El contrato de cálculo ya distingue carrera temporal y distancia exacta por vueltas; capacidad/aplicabilidad VE, reservas independientes y cargas iniciales fijas ya llegan al mismo solver y a la evaluación final Go. El contrato TypeScript y el borrador del asistente ya transportan el evento completo sin fabricar pilotos ni ritmos. El backend acredita la curva combinada y la vida útil derivadas y acepta inventario físico explícito, conservando compuesto, montaje y cambio de neumáticos. El borrador recorded v1 ya custodia el inventario físico y el ritmo por compuesto y los transporta al cálculo sin convertir agregados; los borradores anteriores conservan su JSON. El evento Go acepta ahora un desglose completo de parada y lo lleva al modelo único del solver con precedencia sobre el coste legacy y la proyección. El tiempo de formación también llega al mismo reloj, queda separado de conducción y pilotos y ajusta el horizonte desde su primera estimación. El borrador recorded v1 ya custodia servicios y formación y los transporta al evento sin alterar los borradores anteriores; el asistente ya edita los límites mínimo/máximo de vueltas, los máximos continuo/total por piloto, las ventanas de pit, los compuestos obligatorios, los permitidos por clima y los tramos no disponibles por vueltas sobre las reglas existentes; T03a ya distingue cancelación de plazo agotado, T03b evita colisiones de comandos entre montajes, T03c espera las entradas derivadas cuando hay telemetría seleccionada y T03d rechaza optimalidad desconocida y T03e distingue presupuesto agotado de inviabilidad con clima. T03a–e cierra el contrato actual sin fabricar estados; La disponibilidad horaria sigue pendiente en T07; T15a1 ya conserva el selector de orden recorded y su secuencia exacta; T15a2a #1265 obtiene la proyección conjunta de sus revisiones exactas mediante la autoridad Analysis existente, sin evento duplicado; T15a2b #1268 conserva el delta explícito entre pilotos después de resolver el ritmo observado, sin alterar consumo ni otros perfiles; T15 continuará con el plan parcial y la optimalidad final. Las nuevas revisiones Orbit custodian la entrada exacta del cálculo vigente; cambiar una referencia de fuente impide reconocer la revisión anterior como guardada. El bridge Go ya abre una revisión Orbit por su referencia completa sin consultar la fuente ni sustituirla por la más reciente. El cliente TypeScript transporta esa referencia y rechaza una revisión válida ausente o distinta. La biblioteca publica además todas las referencias históricas sin cargar sus payloads, por lo que A sigue siendo descubrible después de crear B. Mis estrategias muestra los planes guardados aunque ya no tengan borrador y permite elegir y consultar cada resultado histórico exacto sin reabrir su fuente. T15a2c #1269 resuelve la selección libre temporal con el reloj exacto de SolverV2, incluidas formación y paradas, sin estimar vueltas por ritmo medio. T15b #1270 conecta el panel Plan: conserva una condición seca o mojada explícita, prepara las revisiones exactas, valida las familias necesarias y permite calcular o cancelar sin guardar ni aceptar automáticamente; las respuestas antiguas se descartan. T15c #1271 presenta cobertura parcial o el plan exacto de SolverV2 con estados honestos, Fuel/VE, fuentes, versión y criterio de optimalidad; aceptar conserva la petición y el resultado exactos mediante la recuperación duradera de revisiones y sigue separado de guardar la configuración. T16a #1273 reutiliza la secuencia de pilotos y los overrides de vueltas para comparar la propuesta exacta con una variante de stint restringida en el mismo SolverV2. T16b #1274 conecta piloto, límites de stint equivalentes por arrastre/teclado, obsolescencia, recálculo exacto y coste frente a la base. T17a #1275 fija por parada Fuel/VE añadidos y neumáticos físicos en el replay único, con el modo paralelo/secuencial gobernado por el evento. T17b #1276 conecta la edición productiva de esos servicios, el desglose, la obsolescencia, el recálculo sin nueva preparación y el coste exacto. T18 #1277 cierra localmente la paridad A4; pass-28-computer-use suma 22 estados principales y 72 variantes responsive ES/EN/PT/IT, mantiene la base por encima de 9/10, corrige la lista integrada de sesiones y conserva salida y reintento tras una parada inviable. El preflight nativo sustituye el drawer de fuentes por una pantalla A4 completa y repite automáticamente la observación segura que libera los DuckDB estables; queda T22 para completar la aceptación nativa.
- cuerpo.en: Visual direction accepted: a five-step wizard (Start, Combination, Rules, Drivers and Sessions) and A4/Orbit editor with Race, Data, Plan, Revisions, stint and pit-stop details. Combination includes simulator, custom event or Vantare calendar, car/category and track. Local development now validates, stores and applies scalar correction sets with history, conflicts, retries and recovery, then recomputes derivatives while preserving original files and quality. Projections support complete session/base/revision/snapshot references; Analysis derives from an exact stored revision and the client validates its references. The service prepares, saves, loads and projects corrections from a revalidated open session, with persistent custody and recomputed classification. The native client validates responses and propagates cancellation without automatic retries. Document and client preserve exact revisions and reject mismatched projections; selection changes discard prior derivatives while preserving overrides. An authorized adapter jointly projects exact revisions of open sessions. Strategy now requests those revisions through the adapter and validates its response without substitutions. The calculation contract accepts explicit event rules and preserves them through optimization and final validation; document and client preserve sourced rules with compatible versioning, and T15b now carries them from the visible draft into the same engine. The solver reuses identical service costs within each calculation without reducing alternatives; the Imola regression completes in local tests. Native discovery supports up to 1024 files and distinguishes limit overflow from incompatible format. The production Sessions panel supports explicit opening, preparation and revision selection; the native path is checked against real races with original files preserved. Strategy now opens the five-step A4 wizard with unified combination, rules, drivers and sessions. It supports discovering and explicitly accepting a source, saving configuration in the native repository and reopening it from My strategies. The overview preserves missing inputs without presenting a completed calculation. The Plan panel now connects preparation, calculation, and cancellation over exact revisions, with an explicit dry/wet condition and no automatic save. T18 visual parity is locally complete; T22 Wails validation remains. LMU/DuckDB is the first adapter; future simulators use their own formats. Original files stay unchanged, with an optional copy. Partial results, separate Fuel/Virtual Energy, driver estimates and reproducible revisions remain required. The 367-file inventory still needs independent annotation, criteria calibration and held-out complete races. The solver checks feasibility, optimality, resources, reserves and race horizon; physical accuracy and Wails acceptance still require real evidence. Live and OSS/Monte Carlo research follow the recorded workflow. Delivery follows an integrated SDD with dependent tasks, acceptance criteria and continuous execution between slices; only actual product decisions and promotions require further intervention. The library supports sanitized local filename search, availability filters, date ordering and pages of 25 files without automatically opening content. Data now supports paged original samples, reasoned corrections, separate saves, uncertain-save resolution and explicit revision adoption. The planned editing operations are connected and T18 visual acceptance is locally complete; T22 native acceptance remains pending. Revisions can inspect an exact source revision, visit its parents, restore it as a new revision with a reason and explicitly select its data for the race. Data distinguishes readable signals from signals supporting verified corrections. Complete plan history is now available; Analysis and Strategy now recover their complete correction and `save_revision` commands across restarts. Orbit never executes the recovered save automatically: the person can check the exact revision, retry the same identity, or close the notice. The main Data view inspects laps from an exact revision, grouped by recorded stint boundaries. It stages reasoned usage decisions for pace, Fuel, VE, tyres or saving while preserving other families; samples remain in an advanced view. Save, discard and restore retain the complete mixed set. Classification now shows original, saved and proposed values and supports editing type, weather and canonical simulator/car/class/track identity through the authorized catalog, with reversible v4 history. A bidirectional real Imola↔Monza bank verifies projection and restoration without changing the original DuckDB files. #1208 now aligns `GPS Time`, coverage, Fuel, Virtual Energy, wear and pit observations on one proven clock. The real S125/S266/S026 bank removes phantom `fuel_jump` boundaries, preserves correct boundaries and leaves hashes/WAL unchanged; open visits do not invent an end or resources. The boundary contract, validation, v5 custody, effective view, service and client now move, remove, restore and review recorded boundaries without changing the source; final visual and native validation remain pending. The completion plan separates implementation from validation: temporal anchors and boundaries first, then remaining rules, profiles and inputs, reproducible revisions and connected calculation; stint/pit editing and visual, empirical and native acceptance follow. Calibration and native diagnostics are prepared early so their blockers do not stop independent work. The calculation contract now distinguishes timed races from an exact lap distance; VE capacity/applicability, independent reserves and fixed initial loads now reach the same solver and Go final evaluation. The TypeScript contract and wizard draft now carry the complete event without fabricating drivers or pace. The backend proves the derived combined curve and tyre life and accepts explicit physical inventory while preserving compound, fitment and tyre-change decisions. The recorded v1 draft now stores physical inventory and compound pace and carries them into calculation without converting aggregate counts; earlier drafts retain their JSON. The Go event now accepts a complete pit-service breakdown and carries it into the single solver model with precedence over legacy cost and projection. Formation time also reaches the same clock, stays separate from driving and drivers, and adjusts the horizon from its first estimate. The recorded v1 draft now stores services and formation and carries them into the event without changing earlier drafts; the wizard now edits each driver's minimum/maximum laps, continuous/total maximums, required pit windows, mandatory compounds, climate compound allowances and unavailable lap sections through the existing rules; T03a now distinguishes cancellation from an expired deadline, T03b prevents command collisions across mounts, T03c waits for derived inputs when telemetry is selected, and T03d rejects unknown optimality and T03e distinguishes exhausted budget from weather infeasibility. T03a–e closes the current contract without fabricating states; Time-based availability remains pending in T07; T15a1 now preserves the recorded order selector and its exact sequence; T15a2a #1265 obtains the joint projection of its exact revisions through the existing Analysis authority, without a duplicate event; T15a2b #1268 preserves the explicit driver delta after resolving observed pace, without changing consumption or other profiles; T15 continues with a partial plan and final optimality. New Orbit revisions retain the exact input of the current calculation; changing a source reference prevents the previous revision from being recognized as saved. The Go bridge now opens an Orbit revision by its complete reference without querying the source or replacing it with the latest revision. The TypeScript client carries that reference and rejects a valid response when its revision is missing or different. The library also publishes every historical reference without loading payloads, so A remains discoverable after B is created. My strategies shows saved plans even when they no longer have a draft and lets the person choose and inspect each exact historical result without reopening its source. T15a2c #1269 resolves timed free selection with SolverV2's exact clock, including formation and pit stops, without estimating laps from average pace. T15b #1270 connects the Plan panel: it retains an explicit dry or wet condition, prepares the exact revisions, validates required families, and supports calculate or cancel without saving or accepting automatically; stale responses are discarded. T15c #1271 presents partial coverage or the exact SolverV2 plan with honest states, Fuel/VE, sources, version, and optimality criterion; acceptance preserves the exact request and result through durable revision recovery and remains separate from saving configuration. T16a #1273 reuses the driver sequence and lap overrides to compare the exact proposal with a constrained stint variant in the same SolverV2. T16b #1274 connects driver, equivalent drag/keyboard stint boundaries, staleness, exact recalculation, and cost against the base. T17a #1275 fixes added Fuel/VE and physical tyres per stop in the single replay, with parallel/sequential mode governed by the event. T17b #1276 connects productive service editing, breakdown, staleness, recalculation without new preparation, and exact cost. T18 #1277 locally closes A4 parity; pass-28-computer-use adds 22 primary states and 72 ES/EN/PT/IT responsive variants, keeps the visual baseline above 9/10, fixes the embedded session list, and preserves exit and retry after an infeasible pit edit. The native preflight replaces the sources drawer with a full A4 screen and automatically repeats the safe observation that releases stable DuckDB files; T22 remains for complete native acceptance.
- cuerpo.pt: Visão visual aprovada: assistente de cinco passos (Início, Combinação, Regras, Pilotos e Sessões) e editor A4/Orbit com Corrida, Dados, Plano, Revisões, stint e paragem. Combinação reúne simulador, evento personalizado ou calendário Vantare, carro/categoria e circuito. O desenvolvimento local valida, guarda e aplica correções escalares com histórico, conflitos, repetição e recuperação, recalculando derivados sem alterar originais ou qualidade. As projeções aceitam referências completas de sessão/base/revisão/snapshot; Analysis deriva a revisão guardada exata e o cliente valida as referências. O serviço prepara, guarda, consulta e projeta correções de uma sessão aberta revalidada, com custódia persistente e classificação recalculada. O cliente nativo valida respostas e propaga cancelamento sem repetições automáticas. Documento e cliente conservam revisões exatas e rejeitam projeções divergentes; alterar a seleção descarta derivados anteriores preservando ajustes. O adaptador autorizado projeta em conjunto revisões exatas de sessões abertas. Strategy já solicita essas revisões ao adaptador e valida a resposta sem substituições. O contrato de cálculo aceita regras explícitas do evento e mantém-nas na otimização e validação final; documento e cliente preservam regras com origem e versão compatível, e T15b já as leva do rascunho visível ao mesmo motor. O solver reutiliza custos de serviços idênticos em cada cálculo sem reduzir alternativas; a regressão de Imola conclui nos testes locais. A descoberta nativa admite até 1024 ficheiros e distingue excesso de limite de formato incompatível. O painel produtivo de Sessões permite abertura explícita, preparação e seleção de revisões; o percurso nativo é verificado com corridas reais preservando os originais. A secção Estratégia abre o assistente A4 de cinco passos com combinação unificada, regras, pilotos e sessões. Permite descobrir e aceitar uma fonte explícita, guardar a configuração no repositório nativo e reabri-la em Minhas estratégias. O resumo preserva dados ausentes sem apresentar um cálculo concluído. O painel Plano já liga preparação, cálculo e cancelamento sobre revisões exatas, com condição seca/molhada explícita e sem gravação automática. A paridade visual T18 está concluída localmente; resta a validação Wails T22. LMU/DuckDB é o primeiro adapter; outros simuladores terão formatos próprios. Originais intactos e cópia opcional; resultados parciais, Fuel/energia virtual separados, estimativas entre pilotos e revisões reproduzíveis. O inventário de 367 ficheiros aguarda anotação independente, calibração e corridas completas reservadas. O solver verifica viabilidade, optimalidade, recursos, reservas e horizonte; precisão física e aceitação Wails exigem evidência real. Live e pesquisa OSS/Monte Carlo ficam para depois. A entrega segue um SDD integral com tarefas dependentes, critérios de aceitação e execução contínua entre etapas; só decisões reais de produto e promoções exigem nova intervenção. A biblioteca permite procurar nomes locais saneados, filtrar disponibilidade, ordenar por data e percorrer páginas de 25 ficheiros sem abrir conteúdo automaticamente. Dados já permite consultar amostras originais por páginas, preparar correções com motivo, guardá-las separadamente, verificar confirmações incertas e adotar revisões explicitamente. As operações de edição previstas estão ligadas e a aceitação visual T18 está concluída localmente; falta a aceitação nativa T22. Revisões permite consultar uma revisão exata da fonte, visitar as anteriores, restaurá-la como nova revisão com motivo e escolher explicitamente os seus dados para a corrida. Dados distingue sinais consultáveis de sinais que permitem correções verificadas. O histórico completo do plano já pode ser consultado; Analysis e Strategy recuperam após reinício os comandos completos de correção e `save_revision`. O Orbit não executa automaticamente a gravação recuperada: permite verificar a revisão exata, repetir a mesma identidade ou fechar o aviso. A vista principal de Dados consulta voltas de uma revisão exata, agrupadas por limites de stint registados. Permite propor utilização para ritmo, Fuel, VE, pneus ou poupança com motivo, preservando as outras famílias; as amostras ficam na vista avançada. Guardar, descartar e restaurar conservam o conjunto misto completo. A classificação mostra agora os valores original, guardado e proposto e permite corrigir tipo, clima e identidade canónica de simulador/carro/classe/circuito através do catálogo autorizado, com histórico v4 reversível. Um banco real bidirecional Imola↔Monza confirma a projeção e a restauração sem alterar os DuckDB originais. #1208 já alinha `GPS Time`, cobertura, Fuel, energia virtual, desgaste e boxes num único relógio comprovado. O banco real S125/S266/S026 elimina limites `fuel_jump` fantasma, conserva os limites corretos e mantém hashes/WAL intactos; visitas abertas não inventam fim nem recursos. O contrato, a validação, a custódia v5, a vista efetiva, o serviço e o cliente já permitem mover, retirar, restaurar e rever limites registados sem alterar a fonte; falta a validação visual e nativa final. O plano de conclusão distingue implementação e validação: primeiro âncoras temporais e limites, depois regras, perfis e entradas pendentes, revisões reproduzíveis e cálculo ligado; seguem-se edição de stint/paragem e aceitação visual, empírica e nativa. Calibração e diagnóstico nativo são preparados antecipadamente para resolver bloqueios sem parar trabalho independente. O contrato de cálculo já distingue corrida por tempo e distância exata por voltas; capacidade/aplicabilidade VE, reservas independentes e cargas iniciais fixas já chegam ao mesmo solver e à avaliação final Go. O contrato TypeScript e o rascunho do assistente já transportam o evento completo sem fabricar pilotos ou ritmo. O backend comprova a curva combinada e a vida útil derivadas e aceita inventário físico explícito, preservando composto, montagem e troca de pneus. O rascunho recorded v1 já guarda o inventário físico e o ritmo por composto e leva-os ao cálculo sem converter contagens agregadas; os rascunhos anteriores conservam o seu JSON. O evento Go aceita agora uma decomposição completa da paragem e leva-a ao modelo único do solver com precedência sobre o custo legacy e a projeção. O tempo de formação também chega ao mesmo relógio, fica separado da condução e dos pilotos e ajusta o horizonte desde a primeira estimativa. O rascunho recorded v1 já guarda serviços e formação e leva-os ao evento sem alterar rascunhos anteriores; o assistente já edita os limites mínimo/máximo de voltas, os máximos contínuo/total por piloto, as janelas de pit, os compostos obrigatórios, os permitidos por clima e os trechos indisponíveis por voltas nas regras existentes; T03a já distingue cancelamento de prazo esgotado, T03b evita colisões de comandos entre montagens, T03c espera os inputs derivados quando há telemetria selecionada e T03d rejeita optimalidade desconhecida e T03e distingue orçamento esgotado de inviabilidade meteorológica. T03a–e fecha o contrato atual sem inventar estados; A disponibilidade horária continua pendente em T07; T15a1 já conserva o seletor de ordem recorded e a sequência exata; T15a2a #1265 obtém a projeção conjunta das revisões exatas através da autoridade Analysis existente, sem evento duplicado; T15a2b #1268 preserva o delta explícito entre pilotos após resolver o ritmo observado, sem alterar consumo nem outros perfis; T15 continuará com o plano parcial e a optimalidade final. As novas revisões Orbit guardam a entrada exata do cálculo atual; alterar uma referência de origem impede reconhecer a revisão anterior como guardada. O bridge Go já abre uma revisão Orbit pela referência completa sem consultar a origem nem substituí-la pela revisão mais recente. O cliente TypeScript transporta essa referência e rejeita uma revisão válida ausente ou diferente. A biblioteca também publica todas as referências históricas sem carregar payloads, mantendo A acessível após criar B. Minhas estratégias mostra os planos guardados mesmo sem rascunho e permite escolher e consultar cada resultado histórico exato sem reabrir a origem. T15a2c #1269 resolve a seleção livre temporal com o relógio exato de SolverV2, incluindo formação e paragens, sem estimar voltas pelo ritmo médio. T15b #1270 liga o painel Plano: conserva uma condição seca ou molhada explícita, prepara as revisões exatas, valida as famílias necessárias e permite calcular ou cancelar sem guardar nem aceitar automaticamente; as respostas antigas são descartadas. T15c #1271 apresenta cobertura parcial ou o plano exato do SolverV2 com estados honestos, Fuel/VE, fontes, versão e critério de otimalidade; aceitar conserva o pedido e o resultado exatos através da recuperação durável de revisões e continua separado de guardar a configuração. T16a #1273 reutiliza a sequência de pilotos e os overrides de voltas para comparar a proposta exata com uma variante de stint restringida no mesmo SolverV2. T16b #1274 liga piloto, limites de stint equivalentes por arrasto/teclado, obsolescência, recálculo exato e custo face à base. T17a #1275 fixa Fuel/VE adicionados e pneus físicos por paragem no replay único, com o modo paralelo/sequencial governado pelo evento. T17b #1276 liga a edição produtiva dos serviços, o detalhe, a obsolescência, o recálculo sem nova preparação e o custo exato. T18 #1277 fecha localmente a paridade A4; pass-28-computer-use soma 22 estados principais e 72 variantes responsive ES/EN/PT/IT, mantém a base visual acima de 9/10, corrige a lista integrada de sessões e conserva saída e nova tentativa após uma paragem inviável. O preflight nativo substitui o drawer de fontes por um ecrã A4 completo e repete automaticamente a observação segura que liberta DuckDB estáveis; resta T22 para completar a aceitação nativa.
- cuerpo.it: Direzione visiva approvata: procedura in cinque passaggi (Inizio, Combinazione, Regole, Piloti e Sessioni) ed editor A4/Orbit con Gara, Dati, Piano, Revisioni, stint e sosta. Combinazione riunisce simulatore, evento personalizzato o calendario Vantare, auto/categoria e circuito. Lo sviluppo locale valida, conserva e applica correzioni scalari con cronologia, conflitti, ripetizioni e recupero, ricalcolando i derivati senza modificare originali o qualità. Le proiezioni supportano riferimenti completi di sessione/base/revisione/snapshot; Analysis deriva la revisione salvata esatta e il client valida i riferimenti. Il servizio prepara, salva, consulta e proietta correzioni di una sessione aperta rivalidata, con custodia persistente e classificazione ricalcolata. Il client nativo valida le risposte e propaga la cancellazione senza tentativi automatici. Documento e client conservano revisioni esatte e rifiutano proiezioni discordanti; cambiare selezione elimina i derivati precedenti mantenendo le impostazioni. Un adattatore autorizzato proietta insieme revisioni esatte di sessioni aperte. Strategy richiede ora tali revisioni tramite adattatore e verifica la risposta senza sostituzioni. Il contratto di calcolo accetta regole esplicite dell’evento e le conserva nell’ottimizzazione e validazione finale; documento e client conservano regole con provenienza e versione compatibile, e T15b le porta dalla bozza visibile allo stesso motore. Il solver riutilizza costi di servizi identici in ogni calcolo senza ridurre le alternative; la regressione di Imola termina nei test locali. La ricerca nativa supporta fino a 1024 file e distingue il superamento del limite da un formato incompatibile. Il pannello Sessioni consente apertura esplicita, preparazione e selezione delle revisioni; il percorso nativo viene verificato con gare reali conservando gli originali. La sezione Strategia apre la procedura A4 in cinque passaggi con combinazione unificata, regole, piloti e sessioni. Consente di trovare e accettare una fonte esplicita, salvare la configurazione nel repository nativo e riaprirla da Le mie strategie. Il riepilogo conserva i dati mancanti senza presentare un calcolo completato. Il pannello Piano collega ora preparazione, calcolo e annullamento su revisioni esatte, con condizione asciutto/bagnato esplicita e senza salvataggio automatico. La parità visiva T18 è chiusa localmente; resta la validazione Wails T22. LMU/DuckDB è il primo adapter; altri simulatori avranno formati propri. Originali intatti e copia facoltativa; risultati parziali, Fuel/energia virtuale separati, stime tra piloti e revisioni riproducibili. L’inventario di 367 file richiede annotazione indipendente, calibrazione e gare complete riservate. Il solver verifica fattibilità, ottimalità, risorse, riserve e orizzonte; precisione fisica e accettazione Wails richiedono prove reali. Live e ricerca OSS/Monte Carlo seguiranno il flusso registrato. La consegna segue un SDD integrato con attività dipendenti, criteri di accettazione ed esecuzione continua; solo decisioni reali di prodotto e promozioni richiedono un nuovo intervento. La libreria permette di cercare nomi locali sicuri, filtrare la disponibilità, ordinare per data e sfogliare pagine di 25 file senza aprire automaticamente i contenuti. Dati permette di consultare campioni originali per pagina, preparare correzioni motivate, salvarle separatamente, verificare conferme incerte e adottare revisioni esplicitamente. Le operazioni di modifica previste sono collegate e l'accettazione visiva T18 è chiusa localmente; resta l'accettazione nativa T22. Revisioni permette di consultare una revisione esatta della fonte, visitare le precedenti, ripristinarla come nuova revisione con motivo e sceglierne esplicitamente i dati per la gara. Dati distingue i segnali consultabili da quelli che supportano correzioni verificate. La cronologia completa del piano è consultabile; Analysis e Strategy recuperano dopo il riavvio i comandi completi di correzione e `save_revision`. Orbit non esegue automaticamente il salvataggio recuperato: consente di verificare la revisione esatta, ripetere la stessa identità o chiudere l’avviso. La vista principale Dati consulta i giri di una revisione esatta, raggruppati per limiti di stint registrati. Permette proposte motivate di utilizzo per passo, Fuel, VE, pneumatici o risparmio, preservando le altre famiglie; i campioni restano nella vista avanzata. Salvataggio, annullamento e ripristino conservano il set misto completo. La classificazione mostra ora valori originali, salvati e proposti e permette di correggere tipo, meteo e identità canonica di simulatore/auto/classe/circuito tramite il catalogo autorizzato, con cronologia v4 reversibile. Un banco reale bidirezionale Imola↔Monza verifica proiezione e ripristino senza modificare i DuckDB originali. #1208 ora allinea `GPS Time`, copertura, Fuel, energia virtuale, usura e soste su un unico orologio comprovato. Il banco reale S125/S266/S026 elimina i limiti `fuel_jump` fantasma, conserva quelli corretti e mantiene invariati hash/WAL; le visite aperte non inventano fine o risorse. Il contratto, la validazione, la custodia v5, la vista effettiva, il servizio e il client consentono ora di spostare, rimuovere, ripristinare e consultare i limiti registrati senza modificare la fonte; resta la validazione visiva e nativa finale. Il piano di completamento distingue implementazione e validazione: prima riferimenti temporali e limiti, poi regole, profili e input mancanti, revisioni riproducibili e calcolo collegato; seguono modifica di stint/sosta e accettazione visiva, empirica e nativa. Calibrazione e diagnosi nativa vengono preparate prima della chiusura per risolvere i blocchi senza fermare il lavoro indipendente. Il contratto di calcolo distingue ora gara a tempo e distanza esatta in giri; capacità/applicabilità VE, riserve indipendenti e carichi iniziali fissi raggiungono ora lo stesso solver e la valutazione finale Go. Il contratto TypeScript e la bozza della procedura guidata ora trasportano l'evento completo senza inventare piloti o passo. Il backend dimostra la curva combinata e la vita utile derivate e accetta un inventario fisico esplicito, preservando mescola, montaggio e cambio gomme. La bozza recorded v1 ora conserva inventario fisico e ritmo per mescola e li trasporta al calcolo senza convertire conteggi aggregati; le bozze precedenti mantengono il proprio JSON. L’evento Go ora accetta una scomposizione completa della sosta e la porta nel modello unico del solver con precedenza sul costo legacy e sulla proiezione. Il tempo di formazione raggiunge lo stesso orologio, resta separato dalla guida e dai piloti e regola l’orizzonte dalla prima stima. La bozza recorded v1 ora conserva servizi e formazione e li trasporta nell’evento senza modificare le bozze precedenti; la procedura ora modifica i limiti minimo/massimo di giri, i massimi continuativo/totale per pilota, le finestre di pit, le mescole obbligatorie, quelle consentite per clima e i tratti non disponibili per giri nelle regole esistenti; T03a distingue ora l’annullamento dalla scadenza, T03b evita collisioni dei comandi tra montaggi, T03c attende gli input derivati quando è selezionata la telemetria e T03d rifiuta optimality sconosciuta e T03e distingue budget esaurito da impossibilità meteorologica. T03a–e chiude il contratto attuale senza inventare stati; La disponibilità oraria resta in T07; T15a1 ora conserva il selettore dell'ordine recorded e la sequenza esatta; T15a2a #1265 ottiene la proiezione congiunta delle revisioni esatte tramite l'autorità Analysis esistente, senza un evento duplicato; T15a2b #1268 conserva il delta esplicito tra piloti dopo aver risolto il passo osservato, senza modificare consumo o altri profili; T15 continuerà con il piano parziale e l’optimalità finale. Le nuove revisioni Orbit conservano l’input esatto del calcolo corrente; modificare un riferimento della fonte impedisce di riconoscere la revisione precedente come salvata. Il bridge Go ora apre una revisione Orbit tramite il riferimento completo senza consultare la fonte né sostituirla con la revisione più recente. Il client TypeScript trasporta quel riferimento e rifiuta una revisione valida assente o diversa. La libreria pubblica inoltre tutti i riferimenti storici senza caricare i payload, così A resta individuabile dopo la creazione di B. Le mie strategie mostra i piani salvati anche senza bozza e permette di scegliere e consultare ogni risultato storico esatto senza riaprire la fonte. T15a2c #1269 risolve la selezione libera a tempo con il cronometro esatto di SolverV2, includendo formazione e soste, senza stimare i giri dal passo medio. T15b #1270 collega il pannello Piano: conserva una condizione asciutta o bagnata esplicita, prepara le revisioni esatte, convalida le famiglie necessarie e consente di calcolare o annullare senza salvare né accettare automaticamente; le risposte obsolete vengono scartate. T15c #1271 presenta la copertura parziale o il piano esatto di SolverV2 con stati corretti, Fuel/VE, fonti, versione e criterio di ottimalità; l’accettazione conserva richiesta e risultato esatti tramite il recupero durevole delle revisioni e resta separata dal salvataggio della configurazione. T16a #1273 riutilizza la sequenza dei piloti e gli override dei giri per confrontare la proposta esatta con una variante di stint vincolata nello stesso SolverV2. T16b #1274 collega pilota, limiti di stint equivalenti tramite trascinamento/tastiera, obsolescenza, ricalcolo esatto e costo rispetto alla base. T17a #1275 fissa Fuel/VE aggiunti e pneumatici fisici per sosta nel replay unico, con la modalità parallela/sequenziale governata dall’evento. T17b #1276 collega la modifica produttiva dei servizi, il dettaglio, lo stato obsoleto, il ricalcolo senza nuova preparazione e il costo esatto. T18 #1277 chiude localmente la parità A4; pass-28-computer-use aggiunge 22 stati principali e 72 varianti responsive ES/EN/PT/IT, mantiene la base visiva sopra 9/10, corregge la lista sessioni integrata e conserva uscita e nuovo tentativo dopo una sosta non fattibile. Il preflight nativo sostituisce il drawer delle fonti con una schermata A4 completa e ripete automaticamente l’osservazione sicura che libera i DuckDB stabili; resta T22 per completare l’accettazione nativa.
- etiqueta: Plan
- etiqueta.pt: Plano
- etiqueta.it: Piano
