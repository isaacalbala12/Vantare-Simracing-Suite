...
func TestRadioLabMultiCycle(t *testing.T) {
	steps := func(t *testing.T) []radioStep {
		return []radioStep{
			...
			{AdvanceMS: 150, Snapshot: snapV(t, fixtureValues{rivalX: 25, fuelSet: true, fuel: 55, lap: 3, sequence: 5}), Drain: true},
			...
			{AdvanceMS: 150, Snapshot: snapV(t, fixtureValues{rivalX: 25, fuelSet: true, fuel: 55, lap: 3, sequence: 8}), Drain: true},
