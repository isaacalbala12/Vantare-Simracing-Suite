...
export const launcherOrbitIt: Record<string, string> = {
  ...
  "launcher.profile.policy.continue": "Errore · continua",
  ...
  "launcher.editor.policies": "Comportamento del profilo",
  "launcher.editor.alreadyRunning": "Se è già aperta",
  "launcher.editor.failure": "Se un passo fallisce",
  "launcher.editor.cancelPolicy": "Alla cancellazione",
  "launcher.editor.exitPolicy": "All'uscita",
  "launcher.editor.retryPolicy": "Nuovi tentativi automatici",
  "launcher.editor.retryFailed": "Passaggi non riusciti",
  "launcher.editor.retryAll": "Tutti i passaggi",
  "launcher.editor.maxRetries": "Tentativi aggiuntivi",
  "launcher.editor.ask": "Chiedi",
  "launcher.editor.reuse": "Riutilizza",
  "launcher.editor.restart": "Riavvia",
  "launcher.editor.stop": "Ferma la sequenza",
  "launcher.editor.continue": "Continua la sequenza",
  "launcher.editor.leave": "Lascia aperte",
  "launcher.editor.closeStarted": "Chiudi le app avviate da Vantare",
