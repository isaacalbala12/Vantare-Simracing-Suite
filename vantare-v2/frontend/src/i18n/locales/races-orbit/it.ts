...
export const racesOrbitIt: Record<string, string> = {
  ...
  "races.detail.splits": "Auto per split",
  "races.detail.tyres": "Pneumatici",
  "races.detail.warmers": "Termocoperte",
  "races.detail.assists": "Aiuti",
  "races.detail.veLimit": "Limite VE/NRG",
  "races.detail.fairShare": "Equa ripartizione",
  "races.detail.forbiddenBadges": "Distintivi vietati",
  "races.detail.officialNotes": "Avvisi ufficiali",
  "races.detail.yes": "Sì",
  "races.detail.no": "No",
