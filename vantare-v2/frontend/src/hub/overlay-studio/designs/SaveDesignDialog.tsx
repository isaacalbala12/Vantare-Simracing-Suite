  ...
  return (
    ...
    >
      <div className="osv3-dialog-panel osv3-design-dialog">
        ...
        <p className="osv3-dialog-panel__body">{t('studio.v3.design.saveDialog.body')}</p>
        <label className="osv3-design-dialog__field">
          <span className="osv3-design-dialog__label">
            {t('studio.v3.design.saveDialog.nameLabel')}
          </span>
          <input
            type="text"
            value={name}
        ...
        {includesContent ? (
          <p
            className="osv3-dialog-panel__warning"
            data-testid="studio-save-design-content-warning"
          >
