...
const OFFICIAL_DESIGN_DEFINITIONS: WidgetDesignV1[] = [
  ...
  { id: "standings-endurance-tower", name: "Endurance Tower", widgetType: "standings", systemId: "vantare-endurance", systemVersion: 1, configVersion: 1, visual: { templateId: "standings-tower", showSessionHeader: true }, includesContent: false, origin: "vantare", isDefault: true },
