...
**Siguiente corte elegible:** T14a–g conserva, descubre, consulta y recupera cada revisión exacta; Analysis y Strategy retienen sus comandos inciertos completos sin ejecutarlos automáticamente. T03a–e queda cerrado sobre el contrato actual: cancelación, timeout, presupuesto agotado, inviabilidad, resultado vigente y carga pendiente ya tienen rutas comprobadas. T15 conecta el selector recorded, su modo libre temporal, el plan parcial y la optimalidad final. A12/A13 siguen abiertos. La disponibilidad horaria legacy necesita otra referencia temporal y permanece pendiente. T13a–e queda cerrado localmente; la aceptación visual de sus pantallas permanece en T18 y el recorrido Wails en T22.
