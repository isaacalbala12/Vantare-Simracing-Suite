...
- [ ] Añadir una regresión que exija la preparación GTK4/WebKitGTK 6.0 en
  `quality-check` y `quality-audit`; demostrar RED antes del cambio.
- [ ] Instalar y verificar esas dependencias en ambos jobs, sin modificar
  baselines, selección de paquetes ni códigos de salida.
- [ ] Añadir `milestones:quality-linux-analysis` al roadmap como `fix`,
  regenerar `roadmap.json` y actualizar el handoff vivo.
- [ ] Ejecutar suites ratchet/negative, doctor, validadores de roadmap,
