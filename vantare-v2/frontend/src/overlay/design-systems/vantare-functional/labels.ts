...
const en = {
  ...
  trackTemperature: "TRACK", airTemperature: "AIR", estimatedLaps: "EST. LAPS LEFT", totalLaps: "TOTAL LAPS", track: "CIRCUIT", rain: "RAIN", wetness: "WET TRACK",
};

export const functionalLabels: Record<Locale, typeof en> = {
  en,
  es: { ...en, trackTemperature: "PISTA", airTemperature: "AIRE", estimatedLaps: "V. REST. EST.", totalLaps: "V. TOTALES", track: "CIRCUITO", rain: "LLUVIA", wetness: "PISTA MOJADA", driverName: "PILOTO", vehicleClass: "CLASE", gap: "AL LÍDER", paceGap: "AL MEJOR",
  ...
  pt: { ...en, trackTemperature: "PISTA", airTemperature: "AR", estimatedLaps: "V. REST. EST.", totalLaps: "V. TOTAIS", track: "CIRCUITO", rain: "CHUVA", wetness: "PISTA MOLHADA", driverName: "PILOTO", vehicleClass: "CLASSE", gap: "AO LÍDER", paceGap: "AO MELHOR",
  ...
  it: { ...en, trackTemperature: "PISTA", airTemperature: "ARIA", estimatedLaps: "GIRI REST. ST.", totalLaps: "GIRI TOTALI", track: "CIRCUITO", rain: "PIOGGIA", wetness: "PISTA BAGNATA", driverName: "PILOTA", vehicleClass: "CLASSE", gap: "DAL LEADER", paceGap: "DAL MIGLIORE",
