...
**Siguiente corte elegible:** T03 continúa con readiness y estados del resultado;
T03a distingue cancelación de timeout y T03b evita colisiones entre montajes. El backend también distingue orden fijo y selección libre por vueltas; el selector
...
| 6 · T03 | T03a #1248 distingue cancelación de timeout; T03b #1249 hace únicos los comandos de cálculo entre montajes y prueba que respuestas/errores tardíos no contaminan la petición vigente. Continuar con contrato único de resultado y readiness reutilizando evaluación final; reproducir huecos reales de estados. | Casos óptimo demostrado, factible no probado, parcial, inviable, cancelado y presupuesto agotado; respuesta antigua no pasa a vigente; cálculo pendiente de carga no anuncia éxito. |
