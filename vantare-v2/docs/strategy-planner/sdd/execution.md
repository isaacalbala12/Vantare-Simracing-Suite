...
| T13–T18 | T13a–e cerrado localmente; T14a #1254 conserva la entrada exacta del cálculo, T14b #1255 la abre por referencia en Go sin fuente, T14c #1257 exige esa misma referencia en el cliente TypeScript, T14d #1259 publica todas las referencias históricas sin payloads, T14e #1260 permite consultar cada resultado exacto, T14f #1261 recupera el comando completo de corrección y T14g #1263 hace lo mismo con `save_revision`. T15a1 #1264 conecta el criterio de orden recorded, T15a2a #1265 prepara conjuntamente las revisiones exactas, T15a2b #1268 conserva el delta de ritmo por piloto, T15a2c #1269 resuelve el orden libre temporal con el reloj exacto de SolverV2, T15b #1270 conecta preparar/calcular/cancelar y T15c #1271 presenta el resultado exacto o parcial y permite aceptarlo con recuperación. T16a #1273 construye la comparación exacta entre propuesta base y variante con piloto/vueltas de stint restringidos. | Completar controles de stint T16b, parada T17 y paridad T18. |
...
**Siguiente corte elegible:** T16b conecta los controles visuales de piloto/vueltas al comparador exacto de T16a #1273, con teclado, obsolescencia y coste frente a la propuesta base. T15a1–T15c ya conservan criterio, revisiones, delta de piloto y orden libre temporal, conectan el ciclo completo sin perfiles sintéticos y separan guardar configuración de aceptar el plan exacto. A12/A13 quedan cubiertos localmente para el flujo funcional; su gate integral continúa en T22. La disponibilidad horaria legacy necesita otra referencia temporal y permanece pendiente. La aceptación visual permanece en T18 y el recorrido Wails en T22.
