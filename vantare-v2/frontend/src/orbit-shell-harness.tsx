...
/**
 * Harness visual de la shell Orbit.
 *
 * Monta la shell real (rail, columna contextual, topbar, paleta) con un
 * workspace neutro: las páginas de producto dependen del runtime de Wails y no
 * se pueden servir en un navegador limpio. Lo que se compara con
 * `evidence/inicio.png` es exactamente lo que porta este briefing.
 */
      ...
      <I18nProvider>
        <LauncherStoreProvider>
          <OrbitShell
            ...
            version="v0.3.9"
          >
            <div data-testid="orbit-shell-harness-workspace" style={{ height: "100%" }} />
          </OrbitShell>
        </LauncherStoreProvider>
      </I18nProvider>
    </LicenseProvider>
