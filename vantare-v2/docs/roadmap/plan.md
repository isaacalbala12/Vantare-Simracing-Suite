...
- cuerpo: Pendiente en ISA-1331: lista lateral de estrategias guardadas, referencias reales de telemetría en preparación, circuito identificado y continuidad v5 de Carrera, Datos, Plan, Revisiones, Stint y Parada; la revisión parcial no acepta el recorrido completo. La entrada a Strategy aplica su disposición sin animar ni desplazar la interfaz completa. La mesa de preparación sigue la composición v5: contexto compacto, base/fuentes/referencias centrales e inspector de evento y pilotos con acción inferior visible. ISA-1314 aplica localmente el concepto A v5 aprobado: menú previo para elegir una sesión o empezar en manual, escala de grises Orbit, rail comprimido y mesa con combinación, reglas y pilotos accesibles sin asistente obligatorio. La biblioteca conserva búsqueda, filtros, paginación y selección de hasta cuatro fuentes; la identidad se verifica al abrir y los originales permanecen intactos. Manual recoge ritmo, Fuel y VE explícitos y usa el mismo cálculo Go, sin fabricar telemetría. Se conservan correcciones e historial de fuentes, revisiones exactas, guardado de configuración, cálculo/cancelación, cobertura parcial y edición de stint/parada. Guardar configuración y aceptar un plan siguen siendo acciones distintas. El documento de diseño v5 sustituye el garaje y el recorrido A4 como referencia. Los checks y la evidencia de esta entrega se registran por separado en el handoff; la aprobación del HTML no acredita por sí sola paridad productiva ni cierra T22. Siguen pendientes los gates integrales nativos, calibración/anotación independiente y disponibilidad horaria. Live e investigación OSS/Monte Carlo permanecen aplazados. Entrega aislada; no implica integración ni publicación.
- cuerpo.en: Pending in ISA-1331: a saved-strategy sidebar, real telemetry references in preparation, an identified circuit and v5 continuity across Race, Data, Plan, Revisions, Stint and Pit; partial review does not accept the complete workflow. Entering Strategy applies its layout without animating or shifting the entire interface. The preparation desk follows v5: compact context, central base/sources/references and an event/driver inspector with a visible bottom action. ISA-1314 locally applies approved concept A v5: a launch menu to choose a session or start manually, Orbit grayscale, compact rail and a desk with direct access to combination, rules and drivers. The library retains search, filters, pagination and up to four sources; identity is verified on opening and originals stay intact. Manual pace, Fuel and VE estimates use the existing Go calculation without fabricated telemetry. Source corrections/history, exact revisions, configuration saving, calculation/cancellation, partial coverage and stint/pit editing remain available. Saving configuration and accepting a plan remain separate actions. The v5 design document replaces the garage and A4 wizard as the visual reference. Checks and evidence are recorded separately in the handoff; HTML approval alone does not prove production parity or close T22. Integral native gates, independent annotation/calibration and time-based availability remain pending. Live and OSS/Monte Carlo research stay deferred. Isolated delivery, without implying integration or publication.
- cuerpo.pt: Pendente em ISA-1331: lista lateral de estratégias guardadas, referências reais de telemetria na preparação, circuito identificado e continuidade v5 em Corrida, Dados, Plano, Revisões, Stint e Paragem; a revisão parcial não aprova o percurso completo. A entrada em Strategy aplica a disposição sem animar ou deslocar toda a interface. A mesa segue v5: contexto compacto, base/fontes/referências centrais e inspetor de evento e pilotos com ação inferior visível. ISA-1314 aplica localmente o conceito A v5 aprovado: menu para escolher uma sessão ou começar manualmente, cinzentos Orbit, navegação compacta e mesa com acesso direto à combinação, regras e pilotos. A biblioteca mantém pesquisa, filtros, paginação e até quatro fontes; a identidade é verificada ao abrir e os originais ficam intactos. Ritmo, Fuel e VE manuais usam o cálculo Go existente, sem fabricar telemetria. Mantêm-se correções e histórico das fontes, revisões exatas, gravação da configuração, cálculo/cancelamento, cobertura parcial e edição de stint/paragem. Gravar configuração e aceitar plano continuam separados. O documento v5 substitui a garagem e o assistente A4 como referência visual. Checks e evidência ficam no handoff; aprovação do HTML não comprova paridade produtiva nem encerra T22. Permanecem pendentes validação nativa integral, anotação/calibração independente e disponibilidade horária. Live e investigação OSS/Monte Carlo continuam adiados. Entrega isolada, sem integração ou publicação implícita.
- cuerpo.it: In attesa in ISA-1331: elenco laterale delle strategie salvate, riferimenti reali di telemetria nella preparazione, circuito identificato e continuità v5 in Gara, Dati, Piano, Revisioni, Stint e Sosta; la revisione parziale non approva il percorso completo. Strategy applica il layout senza animare o spostare tutta la UI. Il tavolo segue v5: contesto compatto, base/fonti/riferimenti centrali e ispettore evento e piloti con azione inferiore visibile. ISA-1314 applica localmente il concetto A v5 approvato: menu per scegliere una sessione o iniziare manualmente, grigi Orbit, navigazione compatta e tavolo con accesso diretto a combinazione, regole e piloti. La libreria mantiene ricerca, filtri, paginazione e fino a quattro fonti; identità verificata all'apertura e originali intatti. Ritmo, Fuel e VE manuali usano il calcolo Go esistente senza inventare telemetria. Restano correzioni e cronologia delle fonti, revisioni esatte, salvataggio della configurazione, calcolo/annullamento, copertura parziale e modifica di stint/sosta. Salvare la configurazione e accettare un piano restano azioni distinte. Il documento v5 sostituisce garage e procedura A4 come riferimento visivo. Check ed evidenze sono nel handoff; approvare l'HTML non dimostra parità produttiva né chiude T22. Restano verifica nativa integrale, annotazione/calibrazione indipendente e disponibilità oraria. Live e ricerca OSS/Monte Carlo rimangono rinviati. Consegna isolata, senza implicare integrazione o pubblicazione.
- etiqueta: Feature
- etiqueta.pt: Feature
- etiqueta.it: Feature
