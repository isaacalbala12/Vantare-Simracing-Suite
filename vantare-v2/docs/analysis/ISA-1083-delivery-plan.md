...
- [x] CI del código `5db70a08` SUCCESS en `34430760576`; validar de nuevo cualquier cambio posterior antes de integrar. Ficha roadmap corregida y validador canónico local PASS sobre ese código.
