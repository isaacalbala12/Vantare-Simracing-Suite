...
**Siguiente corte elegible:** T15a1 conserva y edita el criterio fijo/libre y la secuencia exacta del borrador recorded; el mapper exige un modo de ritmo explícito y no permite enviar selección libre temporal al solver actual. T15a2 debe formar la entrada completa desde las revisiones seleccionadas y resolver el modo libre temporal sin promedios ni una segunda autoridad. Después T15b conecta calcular/cancelar y T15c el resultado parcial, la optimalidad final y aceptar/guardar separados. A12/A13 siguen abiertos. La disponibilidad horaria legacy necesita otra referencia temporal y permanece pendiente. La aceptación visual permanece en T18 y el recorrido Wails en T22.
...
| 8 · T15a→c | T15a1 #1264 conserva el criterio fijo/libre, secuencia/candidatos y mapeo exacto de variante; legacy equivale a fijo. Continuar con entrada exacta/readiness; ciclo calcular/cancelar; resultado explicable y aceptar/guardar separados. Definir plan parcial y cuándo la evaluación final conserva una optimalidad demostrada. | A12/A13 y E01/E02 controlados: propuesta real, unidades/recursos y procedencia, incertidumbre y límites; estados parciales/finales comprobados, sin tarjeta decorativa ni fórmula alternativa en React. Comparación matemática acotada y replay. |
