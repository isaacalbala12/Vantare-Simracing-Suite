...
**Siguiente corte elegible:** T03 continúa con obsolescencia y estados del resultado;
T03a distingue cancelación de timeout, T03b evita colisiones entre montajes, T03c impide calcular antes de preparar la telemetría seleccionada, T03d rechaza optimalidad desconocida y T03e no confunde presupuesto agotado con inviabilidad meteorológica. El backend también distingue orden fijo y selección libre por vueltas; el selector
recorded y el modo libre temporal se conectan con la petición completa en T15. La disponibilidad horaria
legacy necesita otra referencia temporal y permanece pendiente. T13a–e queda
cerrado localmente; la aceptación
...
| 6 · T03 | T03a #1248 distingue cancelación de timeout; T03b #1249 hace únicos los comandos entre montajes, T03c #1250 impide calcular con el roster mientras se preparan o fallan las entradas de la telemetría seleccionada, T03d #1251 rechaza optimalidad desconocida y T03e #1252 transporta el presupuesto agotado de escenarios meteorológicos como overflow. Continuar con contrato único de resultado y obsolescencia reutilizando evaluación final; reproducir huecos reales de estados. | Casos óptimo demostrado, factible no probado, parcial, inviable, cancelado y presupuesto agotado; respuesta antigua no pasa a vigente; cálculo pendiente de carga no anuncia éxito. |
