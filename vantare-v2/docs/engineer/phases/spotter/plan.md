...
- **Estado de ejecución Corte A:** implementado y revisado: tip funcional local `1af3fb5` (con `cfbe63e` debajo) + commit documental de cierre como HEAD; spec `ACCEPT` (P0-P2=0) y quality `READY` (P0-P2=0);
