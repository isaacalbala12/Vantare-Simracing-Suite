...
| A14 | R15 | Stint/parada editables con recursos, ventanas, inventario y coste válidos; drag y teclado equivalentes. No doble conteo de servicio ni reserva negativa. | Stint PASS local en #1273/#1274. Contrato/replay de parada PASS local en #1275; UI PASS local en #1276 con Fuel/VE, neumáticos físicos, desglose, obsolescencia, recálculo sin nueva preparación y coste exacto. Capturas T18 y gate integral T22 pendientes. |
