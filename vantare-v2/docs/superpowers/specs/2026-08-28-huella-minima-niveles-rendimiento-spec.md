...
- **Higiene (Decisión Isaac, P11)**: antes de cada corrida se cierran Edge y cualquier otra WebView2 (comparten GPU process y contaminan). Radeon Software mantiene su propia sesión ETW (PresentMon "RSXTraceSession"): se documenta y, si conflictúa con la captura, se cierra también.
