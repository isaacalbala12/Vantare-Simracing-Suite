...
export const launcherOrbitPt: Record<string, string> = {
  ...
  "launcher.profile.policy.continue": "Falha · continuar",
  ...
  "launcher.editor.policies": "Comportamento do perfil",
  "launcher.editor.alreadyRunning": "Se já estiver aberta",
  "launcher.editor.failure": "Se um passo falhar",
  "launcher.editor.cancelPolicy": "Ao cancelar",
  "launcher.editor.exitPolicy": "Ao sair",
  "launcher.editor.retryPolicy": "Novas tentativas automáticas",
  "launcher.editor.retryFailed": "Passos falhados",
  "launcher.editor.retryAll": "Todos os passos",
  "launcher.editor.maxRetries": "Tentativas adicionais",
  "launcher.editor.ask": "Perguntar",
  "launcher.editor.reuse": "Reutilizar",
  "launcher.editor.restart": "Reiniciar",
  "launcher.editor.stop": "Parar a sequência",
  "launcher.editor.continue": "Continuar a sequência",
  "launcher.editor.leave": "Deixar abertas",
  "launcher.editor.closeStarted": "Fechar apps iniciadas pelo Vantare",
