...
const inspector = { content: [
  { kind: "select" as const, id: "source", labelKey: "studio.v3.inspector.fuelStrategy.source", path: "source", options: [
    { value: "fuel", labelKey: "studio.v3.inspector.fuelStrategy.fuel" },
    { value: "virtual-energy", labelKey: "studio.v3.inspector.fuelStrategy.virtualEnergy" },
  ], defaultValue: "fuel" },
...
export const fuelStrategyDefinition: WidgetTypeDefinition<FuelStrategyContent, FuelStrategyViewModel> = {
  ...
  parseContent(input: unknown): FuelStrategyContent {
    ...
    if (value.source !== undefined && value.source !== "fuel" && value.source !== "virtual-energy") throw new Error("fuel-strategy source must be fuel or virtual-energy");
    ...
    return {
      historyRows: rows,
      units: "liters",
      showProjection: typeof value.showProjection === "boolean" ? value.showProjection : true,
      source: value.source === "virtual-energy" ? "virtual-energy" : "fuel",
    };
  },
};
