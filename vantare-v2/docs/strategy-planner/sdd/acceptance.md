...
| A14 | R15 | Stint/parada editables con recursos, ventanas, inventario y coste válidos; drag y teclado equivalentes. No doble conteo de servicio ni reserva negativa. | Stint PASS local en #1273/#1274. Contrato/replay de parada PASS local en #1275: Fuel/VE añadidos, neumáticos físicos, servicio paralelo/secuencial y carga VE publicada. UI T17b, capturas T18 y gate integral T22 pendientes. |
