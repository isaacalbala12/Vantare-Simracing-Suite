...
T03a distingue cancelación de timeout, T03b evita colisiones entre montajes y T03c impide calcular antes de preparar la telemetría seleccionada. El backend también distingue orden fijo y selección libre por vueltas; el selector
