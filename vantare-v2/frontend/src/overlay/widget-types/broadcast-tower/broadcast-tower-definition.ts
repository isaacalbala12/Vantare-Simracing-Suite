...
const inspector = { content: [
  { kind: "range" as const, id: "row-count", labelKey: "studio.v3.inspector.broadcastTower.rowCount", path: "rowCount", defaultValue: 5, min: 3, max: 8, step: 1 },
