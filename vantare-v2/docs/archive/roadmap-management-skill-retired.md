...
> **RETIRADA. NO EJECUTAR.** Este workflow dependía de
> `docs/current-plan.md` y de `scripts/generate-roadmap-progress.mjs`, que ya no
> es la fuente operativa vigente. Linear posee estado y progreso; usa
> `docs/README.md` para seleccionar contratos. El contenido restante se
> conserva únicamente como historial del flujo anterior.
