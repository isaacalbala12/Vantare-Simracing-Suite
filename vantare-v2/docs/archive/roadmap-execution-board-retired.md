...
> **HISTÓRICO, NO EJECUTABLE.** Linear posee el roadmap operativo. Conserva
> contexto de minifases anteriores, pero no elige trabajo, rama, base ni estado.

Tablero histórico de minifases y miniplanes.
...
> Actualizacion 2026-08-10: las tablas `0.1.X.X` a `0.9.X.X` se conservan como
> contexto histórico. Linear decide el roadmap operativo; este archivo no
> selecciona trabajo ni estado.
...
1. Leer `AGENTS.md`.
2. Abrir la issue de Linear asignada.
3. Usar `docs/README.md` para elegir los contratos aplicables.
...
12. Actualizar Linear y el handoff solo si cambia la continuidad tecnica.
...
1. Actualizar Linear y, si cambia la continuidad tecnica, el handoff aplicable.
...
- Crear o consolidar `docs/changelog.md` como changelog publico orientado a testers/usuarios, y seguir el [Runbook de Operaciones de Release/Beta](../release-beta-operations-runbook.md) para el despliegue.
