...
const canonicalEntries = [
  { id: 'relative', widgetType: 'relative', designId: 'relative-crystal-vertical', referenceSelector: '.widgets-row > .glass-card:nth-child(1)', width: 358, height: 288, htmlSection: 1 },
  { id: 'standings', widgetType: 'standings', designId: 'standings-crystal-vertical', referenceSelector: '.widgets-row > .glass-card:nth-child(2)', width: 361, height: 650, htmlSection: 1 },
  ...
  { id: 'pedals-telemetry', widgetType: 'pedals-telemetry', designId: 'pedals-telemetry-crystal', referenceSelector: '.telemetry-showcase > .telemetry-col:nth-child(1)', width: 324, height: 152, htmlSection: 4 },
  { id: 'pedals-telemetry-compact', widgetType: 'pedals-telemetry-compact', designId: 'pedals-telemetry-compact-crystal', referenceSelector: '.telemetry-showcase > .telemetry-col:nth-child(2)', width: 281, height: 172, htmlSection: 4 },
  { id: 'pedals', widgetType: 'pedals', designId: 'pedals-crystal', referenceSelector: '.telemetry-showcase > .telemetry-col:nth-child(3)', width: 241, height: 261, htmlSection: 4 },
  ...
  { id: 'head-to-head', widgetType: 'head-to-head', designId: 'head-to-head-crystal', referenceSelector: '.h2h-container', width: 780, height: 151, htmlSection: 9 },
  { id: 'input-blade', widgetType: 'input-telemetry', designId: 'input-crystal-blade', referenceSelector: '.in10a-container', width: 780, height: 97, htmlSection: 10 },
  { id: 'input-capsule', widgetType: 'input-telemetry', designId: 'input-crystal-capsule', referenceSelector: '.in10b-container', width: 780, height: 101, htmlSection: 10 },
  { id: 'input-dense', widgetType: 'input-telemetry', designId: 'input-crystal-dense', referenceSelector: '.in10c-container', width: 780, height: 69, htmlSection: 10 },
  { id: 'multiclass', widgetType: 'multiclass-relative', designId: 'multiclass-relative-crystal', referenceSelector: '.mc-container', width: 780, height: 211, htmlSection: 11 },
  { id: 'weather', widgetType: 'track-weather', designId: 'track-weather-crystal', referenceSelector: '.tw-container', width: 240, height: 421, htmlSection: 12 },
  { id: 'damage-visual', widgetType: 'car-damage-visual', designId: 'car-damage-visual-crystal', referenceSelector: '.w13-car-visual', width: 150, height: 191, htmlSection: 13 },
  { id: 'damage-numbers', widgetType: 'car-damage-numbers', designId: 'car-damage-numbers-crystal', referenceSelector: '.w14-damage-nums', width: 140, height: 149, htmlSection: 14 },
  { id: 'delta-simple', widgetType: 'delta', designId: 'delta-crystal-simple', referenceSelector: '.w15-delta-simple', width: 420, height: 70, htmlSection: 15 },
  { id: 'delta-advanced', widgetType: 'delta-advanced', designId: 'delta-advanced-crystal', referenceSelector: '.w16-delta-adv', width: 480, height: 43, htmlSection: 16 },
];
