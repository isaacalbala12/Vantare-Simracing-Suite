...
## Inventario B0 → rutas exactas verificadas (14/14, corregido tras review adversarial)
...
Orden corregido: `B1 → C2 → B3 → B2-prep → B2`. El guard C2 enumera 18
anclas actuales.
...
- C2 callers/previews/fixtures (18 anclas).
