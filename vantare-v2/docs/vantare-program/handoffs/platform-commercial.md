...
**Base vigente y rendimiento 2026-09-23:** por petición de Isaac se incorporó `nightly@8b25d076` en `5fc8fff8` sin force-push; el digest generado del roadmap se regeneró y verificó. En ese SHA, [promoción/roadmap y gate Windows](https://github.com/isaacalbala12/Vantare-Simracing-Suite/actions/runs/35847190898) **SUCCESS**, incluida suite Go/frontend y build Wails. [Quality](https://github.com/isaacalbala12/Vantare-Simracing-Suite/actions/runs/35847191220/job/107136083019) conserva `REVIEW_REQUIRED` por política, NEW=0, MOVED=0; GitGuardian SUCCESS. El [informe de rendimiento](../../analysis/isa-1325-go-127-performance.md) documenta un A/B de diez pares Windows sobre el mismo árbol: `WriteBatch` sintético hasta snapshot retenido, con demanda registrada pero sin entrega al frontend, empeora un 39,1 % en tiempo y 34,8 % en bytes/op con Go 1.27.1 predeterminado. El opt-out temporal `GOEXPERIMENT=nojsonv2` recupera un 30,5 % de tiempo y 25,6 % de bytes en una contraprueba Windows de diez pares; tests focales SUCCESS. Se aplicó en las builds Windows canónicas y CI/release, con comprobación del binario. Su pipeline completo en el HEAD final sigue pendiente. El PR permanece draft, sin integración ni release.
