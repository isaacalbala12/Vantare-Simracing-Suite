...
| En ejecución | ISA-105 / TC-07A, D1/D2 publicados en `2de5165` |
| Nuevo bloqueo previo a shadow | ISA-129 / TC-07A.1 |
| Pendientes | ISA-106–117 e ISA-87 según dependencias |

## Siguiente acción exacta

Cerrar ISA-105 / TC-07A sobre `3b44d367`: decoder, adapter, los 18 ViewModels,
comparator y reporte sanitizado únicamente en harness. La auditoría demuestra
un exacto, cinco parciales, once no comparables y un externo. Después ejecutar
ISA-129 / TC-07A.1 para parrilla/timing/gaps/delta/sesión/unidades y retirar el
fallback mock conectado antes de ISA-106. Sin CSS, canvas, renderers,
regeneración de baselines ni cutover productivo.
...
2026-07-31, ISA-105 D1/D2 aprobados y publicados en `2de5165`: decoder fiel al
productor Go y adapter `mapped | blocked`, sin datos inventados ni wiring
productivo. La review obligó a aceptar el zero-value missing real, separar la
semántica de `controlsHistory`, rechazar identidades vacías y contener overflow
de velocidad. D3 está en corrección adversarial; ISA-129 sigue siendo
dependencia obligatoria previa a ISA-106. Sin promoción.
