...
| 12 · T18 / #1277 · cerrado localmente | Capturas comparables de asistente, Carrera, Datos avanzado, Cálculo, Plan, Revisiones, Stint y Parada en estados obligatorios; 18 principales y 72 variantes responsive ES/EN/PT/IT en `evidence/isa-1277-visual/pass-22`. | Revisión exclusivamente visual separada: mínimo global 9,1/10, todas las pantallas >9,0; `responsive.json` sin overflow, errores ni foco invisible. T22 conserva el gate nativo. |
