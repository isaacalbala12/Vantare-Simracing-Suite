...
## Fase 2 · Kit de componentes (1–2 sprints)
...
## Fase 3 · Inicio + Ajustes (1 sprint)
...
## Fase 4 · Studio + Launcher (1 sprint)
...
## Fase 7 · Ingeniero + Telemetría + Roadmap (1–2 sprints)
...
- **Dos sistemas conviviendo** durante el porte → feature flag `hub.orbit` por página; shell nueva desde la fase 1 con páginas viejas dentro.
