...
- Rama creada desde `origin/nightly@b635d795` y sincronizada antes de la entrega con `origin/nightly@fa9285e`; lista para review, sin merge de PR, promoción ni release.
