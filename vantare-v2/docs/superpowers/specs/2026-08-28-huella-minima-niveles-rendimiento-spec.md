...
2. Nivel 3 debe ser ≥ 25 % mejor que hoy en CPU total de Vantare y ≥ 20 % en RAM privada con hub minimizado (medido 405,34 MiB, −27,88 % vs 562 MiB, 2026-08-30), sin empeorar frametime del juego. Este gate no promociona el nivel 3: el default productivo sigue en nivel 1 mientras esa decisión permanezca abierta.
