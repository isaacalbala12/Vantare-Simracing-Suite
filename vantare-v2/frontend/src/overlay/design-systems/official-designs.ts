...
const OFFICIAL_DESIGN_DEFINITIONS: WidgetDesignV1[] = [
  ...
  { id: "standings-endurance-redline-tower", name: "Endurance Redline Tower · Preview", widgetType: "standings", systemId: "vantare-endurance", systemVersion: 1, configVersion: 1, visual: { templateId: "standings-redline", showSessionHeader: true, redlineTheme: "tower", redlineHeader: "current", redlineSelection: "glow", redlineSurfaceOpacity: 0.95 }, includesContent: false, origin: "vantare" },
