...
| T13–T18 | T13a–e cerrado localmente; T14a #1254 conserva la entrada exacta del cálculo, T14b #1255 la abre por referencia en Go sin fuente, T14c #1257 exige esa misma referencia en el cliente TypeScript, T14d #1259 publica todas las referencias históricas sin payloads, T14e #1260 permite consultar cada resultado exacto, T14f #1261 recupera el comando completo de corrección y T14g #1263 hace lo mismo con `save_revision`. T15a1 #1264 conecta el criterio de orden recorded, T15a2a #1265 prepara conjuntamente las revisiones exactas, T15a2b #1268 conserva el delta de ritmo por piloto, T15a2c #1269 resuelve el orden libre temporal con el reloj exacto de SolverV2, T15b #1270 conecta preparar/calcular/cancelar y T15c #1271 presenta el resultado exacto o parcial y permite aceptarlo con recuperación. T16a #1273 construye la comparación exacta y T16b #1274 conecta piloto, límites accesibles, obsolescencia, recálculo y coste. T17a #1275 fija servicios y neumáticos de cada parada y los valida en el replay único; T17b #1276 conecta Fuel, VE y neumáticos editables, desglose, obsolescencia, recálculo y coste. | Paridad visual T18 y gate nativo T22. |
...
| 8 · T15a→c | T15a1 #1264 conserva el criterio fijo/libre, secuencia/candidatos y mapeo exacto de variante; legacy equivale a fijo. T15a2a #1265 solicita la proyección conjunta de las revisiones exactas mediante el productor Analysis existente, sin escritura ni segunda autoridad. T15a2b #1268 resuelve cadenas de estimación y aplica en Go un delta que sólo modifica el ritmo. T15a2c #1269 usa el reloj exacto de SolverV2 para el orden libre temporal, incluidas formación y paradas, sin semilla media. T15b #1270 persiste una condición seca/mojada explícita, valida familias y revisiones exactas, y conecta preparar/calcular/cancelar descartando respuestas antiguas sin guardar. T15c #1271 muestra cobertura parcial o el plan exacto, distingue optimalidad y estados terminales, y acepta la revisión exacta mediante `save_revision` recuperable. | A12/A13 y E01/E02 controlados localmente: propuesta real, unidades/recursos y procedencia, incertidumbre y límites; estados parciales/finales comprobados, sin tarjeta decorativa ni fórmula alternativa en React. Comparación matemática acotada y replay. |
...
| 12 · T18 / #1277 · recorrido adversarial completado | Capturas comparables de asistente, biblioteca en pantalla A4 completa, Carrera, Datos avanzado, Cálculo, Plan, Revisiones, Stint y Parada. La UI repite la observación segura para liberar DuckDB estables, separa los metadatos de cada sesión y conserva salida/reintento tras un recálculo manual inviable. | `pass-28-computer-use`: 22 estados principales y 72 variantes ES/EN/PT/IT, incluida la entrada real desde Combinación; base visual 9,2/10, tres regresiones inspeccionadas sin P0/P1/P2 y matriz sin overflow/error. T22 debe confirmar apertura real, persistencia, reinicio, copia, errores y licencia. |
