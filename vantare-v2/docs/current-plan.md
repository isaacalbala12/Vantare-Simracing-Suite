...
- Corrección de review: restore elimina una credencial protegida inválida/corrupta; `Rotate`, `Clear` y restore están serializados para impedir que una rotación concurrente resucite una sesión cerrada.
...
- Portal limitado a return URLs HTTPS exactas configuradas en servidor. Cliente Polar con entorno sandbox/production estricto, timeout/cancelación también durante lectura del body y errores públicos sanitizados.
