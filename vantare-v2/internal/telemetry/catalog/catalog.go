...
var definitions = []Definition{
	...
	{ID: SignalStandingsPosition, Key: "standings.position", Domain: schema.DomainStandings, Unit: schema.UnitCount, Range: schema.ClosedRange(1, 104), Action: LedgerHardened, Notes: "One-based position within the canonical vehicle bound (1..104)."},
	...
	{ID: SignalSessionVehicleCount, Key: "session.vehicle_count", Domain: schema.DomainSession, Unit: schema.UnitCount, Range: schema.ClosedRange(0, 104), Action: LedgerReused, Notes: "Canonical vehicle-count bound (0..104)."},
