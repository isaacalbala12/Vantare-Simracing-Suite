...
- cuerpo: Eficiencia ofrece los estilos Signature y Broadcast para Standings desde Studio, con transparencia suave, identidad Vantare, tipografía unificada y selección neutra. Los perfiles y diseños guardan esta selección; el marco adapta columnas y filas en Studio, Desktop y OBS. En ISA-1120 se compararon seis direcciones v2 dentro del Workshop y Isaac eligió Foco como dirección a seguir junto al diseño vigente. En ISA-1128 el lenguaje se extiende a Relative, Delta y Pedals con diseño Signature. En ISA-1183 se añaden los renderers Functional para TrackWeather, TrackMap, PedalsTelemetry, FuelStrategy, CarDamageNumbers, InputTelemetry, RacingFlags y RaceSchedule, se registran sus diseños oficiales y se abren al Workshop de desarrollo, manteniendo el estilo no LMU y los datos canónicos del frame v2. Pendiente de validación física, integración a Nightly y los tipos nuevos de historial de vueltas, race-info y dash.
- cuerpo.en: Efficiency offers Signature and Broadcast styles for Standings in Studio, with subtle transparency, Vantare identity, unified typography and neutral selection. Profiles and designs preserve this choice; the frame fits columns and rows across Studio, Desktop and OBS. ISA-1120 compared six v2 directions inside the Workshop and Isaac chose Foco as the direction to pursue alongside the current design. ISA-1128 extends the language to Relative, Delta and Pedals with a Signature design. ISA-1183 adds Functional renderers for TrackWeather, TrackMap, PedalsTelemetry, FuelStrategy, CarDamageNumbers, InputTelemetry, RacingFlags and RaceSchedule, registers their official designs and opens them in the development Workshop while keeping the non-LMU style and canonical v2 frame data. Pending physical validation, Nightly integration and the new lap-history, race-info and dash widget types.
- cuerpo.pt: Eficiência oferece os estilos Signature e Broadcast para Standings no Studio, com transparência suave, identidade Vantare, tipografia unificada e seleção neutra. Perfis e desenhos preservam a escolha; o quadro adapta colunas e filas no Studio, Desktop e OBS. A ISA-1120 comparou seis direções v2 dentro do Workshop e Isaac escolheu Foco como direção a seguir junto ao desenho vigente. A ISA-1128 estende a linguagem a Relative, Delta e Pedals com design Signature. A ISA-1183 adiciona renderers Funcional para TrackWeather, TrackMap, PedalsTelemetry, FuelStrategy, CarDamageNumbers, InputTelemetry, RacingFlags e RaceSchedule, regista os seus designs oficiais e abre-os no Workshop de desenvolvimento, mantendo o estilo não LMU e os dados canónicos do frame v2. Pendente de validação física, integração em Nightly e os novos tipos de widget para histórico de voltas, race-info e dash.
- cuerpo.it: Efficienza offre gli stili Signature e Broadcast per Standings in Studio, con trasparenza lieve, identità Vantare, tipografia unificata e selezione neutra. Profili e design conservano la scelta; il riquadro adatta colonne e righe in Studio, Desktop e OBS. ISA-1120 ha confrontato sei direzioni v2 dentro il Workshop e Isaac ha scelto Foco come direzione da seguire insieme al disegno vigente. ISA-1128 estende il linguaggio a Relative, Delta e Pedals con design Signature. ISA-1183 aggiunge i renderer Functional per TrackWeather, TrackMap, PedalsTelemetry, FuelStrategy, CarDamageNumbers, InputTelemetry, RacingFlags e RaceSchedule, registra i loro design ufficiali e li apre nel Workshop di sviluppo mantenendo lo stile non LMU e i dati canonici del frame v2. In attesa di validazione fisica, integrazione Nightly e i nuovi tipi di widget per lap history, race-info e dash.
- etiqueta: ISA-1183
