...
Nota vigente ISA-884 (2026-08-27): el runtime productivo actual es
`MatrixVersion=6`, definido por `authorityMatrixV4` y expuesto mediante
...
de 500 ms. V6 incorpora `standings.lap_progress_time` como señal SHM-only de
cada fila scoring, también con TTL de 500 ms. La fuente de verdad ejecutable es `fusion.go`, protegida por
