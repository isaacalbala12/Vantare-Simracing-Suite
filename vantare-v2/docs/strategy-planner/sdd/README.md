...
| Motor/entradas | SolverV2, replay final y corrección local del coste repetido #1089; transporte de reglas #1092; horizonte exacto por vueltas T02d1 #1222; capacidad/reservas T02d2a #1224; cargas fijas del solver T02d2b #1225 y transporte Go T02d2c #1226. | T02/T03/T06/T07 no completos: #1241 edita límites de vueltas, #1242 ventanas obligatorias de pit, #1243 compuestos obligatorios, #1244 compuestos permitidos por clima y #1245 indisponibilidad por vueltas; quedan disponibilidad horaria, semántica de orden, estados y conexión productiva T15. |
